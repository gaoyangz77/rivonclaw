...
export const AffiliateActionProposalModel = types.model("AffiliateActionProposal", {
  ...
  campaignId: types.maybeNull(types.string),
  creatorId: types.maybeNull(types.string),
  creatorFollowerCount: types.maybeNull(types.number),
  ...
  requestedByActorType: types.maybeNull(types.string),
  requestedByActorId: types.maybeNull(types.string),
  revisionOfProposalId: types.maybeNull(types.string),
  revisionRootProposalId: types.maybeNull(types.string),
  revisionNumber: types.optional(types.number, 1),
  supersededByProposalId: types.maybeNull(types.string),
  revisionHistory: types.optional(types.array(types.frozen<Record<string, any>>()), []),

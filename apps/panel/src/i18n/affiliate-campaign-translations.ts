const en = {
  ...
  dynamicDiscoveryDescription: "While the campaign runs, your Desktop Agent creates one search plan at a time from the product, direction, and previous plan results.",
  ...
  dynamicDiscoveryDesktopRequired: "When Desktop is offline, outreach stays enabled but waits without using a cloud model.",
  ...
  waitingDesktopPlanDescription: "Start the assigned Desktop to let the user's default model generate the next plan.",
  ...
  searchPlanStatus: {
    idle: "Idle",
    waiting_for_desktop_agent: "Waiting for Desktop Agent",
...
const zh = {
  ...
  dynamicDiscoveryDescription: "Campaign 运行期间，Desktop Agent 会结合商品、长期方向和历史计划结果，一次生成一个搜索计划。",
  dynamicDiscoverySequential: "当前计划到达终态后，才会生成下一计划。",
  dynamicDiscoveryPageLimit: "每个计划保存可恢复游标，最多完成 50 个成功页面。",
  dynamicDiscoveryDesktopRequired: "Desktop 离线时 Campaign 仍保持启用，但不会调用云端模型，只会等待。",
  ...
  waitingDesktopPlanDescription: "启动该店铺绑定的 Desktop，系统将使用用户默认模型生成下一计划。",
  ...
  searchPlanStatus: {
    idle: "空闲",
    waiting_for_desktop_agent: "等待 Desktop Agent",
    generating: "生成中",
    active: "搜索中",
    plan_active: "搜索中",
    blocked: "已阻塞",

const en = {
  ...
  selectSearchPlanForCreators:
    "Select a set of search conditions to inspect its creator decisions.",
...
const zh = {
  ...
  selectSearchPlanForCreators: "请选择一组搜索条件，再查看其候选达人决策。",
...
const operationalCopy = {
  ...
  es: {
    ...
    selectSearchPlanForCreators:
      "Selecciona unas condiciones de búsqueda para revisar sus creadores.",
  ...
  fr: {
    ...
    selectSearchPlanForCreators:
      "Sélectionnez des conditions de recherche pour consulter leurs Creators.",

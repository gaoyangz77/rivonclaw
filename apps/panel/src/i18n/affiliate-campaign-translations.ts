const en = {
  ...
  waitingDesktopPlanDescription: "Generating with the user's default model. Eligible Cloud LLM subscriptions use Backend generation first; Desktop takes over when needed.",
  ...
  searchPlanStatus: {
    idle: "Idle",
    waiting_for_desktop_agent: "Waiting for plan generation",
...
const zh = {
  ...
  waitingDesktopPlanDescription: "系统正在使用用户默认模型生成下一计划；符合条件的云端订阅优先由 Backend 生成，必要时由 Desktop 接管。",
  ...
  searchPlanStatus: {
    idle: "空闲",
    waiting_for_desktop_agent: "等待生成搜索计划",
    generating: "生成中",
    active: "搜索中",
    plan_active: "搜索中",
    blocked: "已阻塞",
...
const operationalCopy = {
  de: {
    waitingDesktopPlanDescription: "Der nächste Plan wird mit dem Standardmodell des Nutzers erzeugt. Bei berechtigten Cloud-Abos startet das Backend; Desktop übernimmt bei Bedarf.",
  ...
  es: {
    waitingDesktopPlanDescription: "El siguiente plan se genera con el modelo predeterminado del usuario. Las suscripciones Cloud aptas usan primero Backend; Desktop toma el relevo si hace falta.",
  ...
  fr: {
    waitingDesktopPlanDescription: "Le prochain plan est généré avec le modèle par défaut de l’utilisateur. Les abonnements Cloud éligibles utilisent d’abord le Backend ; Desktop prend le relais si nécessaire.",
  ...
  id: {
    waitingDesktopPlanDescription: "Rencana berikutnya dibuat dengan model default pengguna. Langganan Cloud yang memenuhi syarat memakai Backend lebih dahulu; Desktop mengambil alih bila perlu.",
  ...
  it: {
    waitingDesktopPlanDescription: "Il prossimo piano viene generato con il modello predefinito dell’utente. Gli abbonamenti Cloud idonei usano prima il Backend; Desktop subentra se necessario.",
  ...
  th: {
    waitingDesktopPlanDescription: "ระบบกำลังสร้างแผนถัดไปด้วยโมเดลเริ่มต้นของผู้ใช้ การสมัคร Cloud ที่มีสิทธิ์จะใช้ Backend ก่อน และ Desktop จะรับช่วงเมื่อจำเป็น",

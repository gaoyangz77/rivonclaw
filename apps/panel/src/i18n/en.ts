export default {
  ...
  adsManagement: {
    ...
    connectShopAds: "Authorize Shop Ads",
    totalAdvertisers: "Ad accounts",
    authorizedAdvertisers: "Authorized",
    adsReadyShops: "Ads-ready shops",
    totalBusinessConnections: "Business connections",
    authorizedBusinessConnections: "Authorized",
    ...
    businessAccountHint: "Advertisers are TikTok Ads API scopes. Store coverage is only actionable when the store maps back to an EasyClaw-authorized shop.",
    businessTableTitle: "Business Connections",
    businessTableSubtitle: "Each connection is a TikTok Business authorization. The advertisers under it provide campaign and reporting access.",
    emptyBusinessTitle: "No TikTok Business connection",
    emptyBusinessBody: "Connect the user's TikTok Business or Ads Manager account, then review which authorized shops are visible through its advertisers.",
    defaultBusinessName: "TikTok Business connection",
    advertiserTableTitle: "Advertising Accounts",
    advertiserTableSubtitle: "These accounts are used by Airflow to sync campaign, ad group, ad, and GMV Max reporting data.",
    emptyAdvertisersTitle: "No advertising accounts connected",
    emptyAdvertisersBody: "Advertising accounts will appear after TikTok Business authorization succeeds.",
    ...
    unmatchedStoreCount: "{{count}} unmatched advertiser-visible store(s)",
    ...
    shopOAuthModalTitle: "Authorize TikTok Shop",
    openShopAuthLink: "Open the TikTok Shop authorization link",
    shopOAuthHint: "Open this link in a browser signed in to the TikTok Shop seller account for this shop.",
    waitingShopAuth: "Waiting for TikTok Shop authorization...",
    shopOAuthSuccess: "TikTok Shop authorization completed.",
    shopOAuthFailed: "Failed to start TikTok Shop authorization.",
    shopOAuthTimeout: "Shop authorization timed out. Refresh the page if authorization completed in the browser.",
    ...
    shopAdsStatus: {
      ...
      needs_advertiser: "No Business connection",
    },
  },
  modules: {
    title: "Modules",
  ...
  ecommerce: {
    ...
    shopDrawer: {
      ...
      affiliate: {
        ...
        minP50SalesUnits: "Minimum P50 sales units",
        minP50SalesUnitsHint: "When a collaboration has no more specific campaign threshold, the agent uses this as the default proceed/sample-review reference. Leave empty for no default numeric threshold.",
        noThreshold: "Not set",
        invalidDecisionThreshold: "Minimum P50 sales units must be an integer greater than or equal to 0.",
        businessPrompt: "Business Prompt",

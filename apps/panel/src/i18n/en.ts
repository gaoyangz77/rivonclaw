export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      historyTitle: "Affiliate collaborations",
      historySubtitle: "Browse collaboration records and open one to review its proposal and lifecycle history.",
      ...
      collaborationRecordsHint: "Defaults to in-progress collaborations. Change the filter to inspect all MongoDB collaboration records.",
      pageTitles: {
      ...
      productContextConfirmed: "Product linked; details unavailable",

export default {
  ...
  tutorial: {
    ...
    adsManagement: {
      ...
      welcomeBody: "This page connects TikTok Business access and shows which EasyClaw-authorized shops are covered by advertiser-visible stores.",
      actionsTitle: "Connect and Refresh",
      actionsBody: "Use Connect TikTok Business to authorize advertiser access. Refresh updates advertisers, visible stores, and shop coverage.",
      summaryTitle: "Coverage Summary",
      summaryBody: "These counters separate authorized advertisers from shops that can actually be managed in EasyClaw.",
      advertisersTitle: "Advertising Accounts",
      advertisersBody: "Each row is an advertiser available through the TikTok Business authorization, including role, token status, and visible store count.",
      shopCoverageTitle: "Managed Shop Coverage",
      shopCoverageBody: "Only shops already authorized in EasyClaw become actionable. Advertiser-visible stores that are not onboarded remain informational.",
    },
    providers: {
  ...
  adsManagement: {
    ...
    emptyAdvertisersBody: "Connect TikTok Business or Ads Manager to discover advertisers and their visible stores.",
    shopReadinessTitle: "Shop Ads Readiness",
    shopReadinessSubtitle: "Review each connected shop's Ads account coverage, store visibility, and GMV Max readiness.",
    shopCoverageTitle: "Managed Shop Coverage",
    shopCoverageSubtitle: "These are EasyClaw-authorized shops that can be matched to advertiser-visible stores.",
    unonboardedStoreCount: "{{count}} advertiser-visible store(s) are not onboarded in EasyClaw",
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      creatorThreadPrimaryObject: "Collaboration record",
      creatorRelationshipPrimaryObject: "Creator relationship",
      creatorThreads: "Collaboration records",
      ...
      threadActiveCollaborations: "Active collaborations",
      threadPendingProposals: "Pending proposals",
      threadUnread: "Unread",
      threadMoreCollaborations: "+{{count}} more collaborations",
      ...
      threadActiveWorkTitle: "{{count}} active collaboration(s)",
      threadRelationshipConversationTitle: "Relationship conversation",
      threadAmbiguousSummary: "This collaboration record has multiple possible product contexts. Review before taking product-specific action.",
      threadDefaultSummary: "Shop-level creator collaboration record. Product collaborations appear here when product or sample context is known.",
      openCreatorThreadDetailHint: "Open the collaboration record for conversation, proposals, and related collaborations.",
      ...
      copyThreadSystemId: "Copy system ID",
      ...
      itemKinds: {
        ...
        ONGOING_COLLABORATION: "In progress",
    ...
    shopAdsStatus: {
      ...
      hint_needs_link: "A TikTok Ads account is connected, but this shop still needs Ads store visibility verification.",
    ...
    shopDrawer: {
      ...
      affiliate: {
        ...
        modelUsageScopeHint: "Choose whether this shop uses the account-level affiliate model or its own shop-level model for expected-sales predictions.",

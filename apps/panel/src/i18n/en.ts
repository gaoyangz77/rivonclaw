export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      intelligenceClaimPrecisionTitle: "More precise at the same sample budget",
      intelligenceClaimPrecisionBody: "At the same sample budget, the model ranks creators expected to sell {{lift}} more than historical staff choices.",
      intelligenceClaimPrecisionNeutral: "At the same sample budget, this model run does not yet show a clear precision lift.",
      ...
      intelligenceChartSameBudget: "Same approval volume",
      intelligenceChartSameSalesBar: "Same expected-sales bar",
      intelligenceChartCreatorSwap: "Who the model would swap",
      intelligenceSameBudgetStory: "{{window}} · same {{count}} approved samples as the historical team",
      ...
      intelligenceModelSelector: "Prediction model",
      intelligenceHumanSelector: "Historical staff",
      ...
      intelligenceBudgetStatsTitle: "Precision claim details",
      intelligenceBudgetStatsHeadline: "Same number of samples, stronger expected sales mix",
      intelligenceBudgetStatsHint: "{{window}} · historical staff choices versus model-ranked choices at the same approval count.",
      intelligenceHistoricalExpectedUnits: "historical expected units",
      intelligenceModelExpectedUnits: "model expected units",
      intelligenceHistoricalApprovedExpected: "Historical approved · expected sales",
      intelligenceReachStatsTitle: "Qualified reach claim details",

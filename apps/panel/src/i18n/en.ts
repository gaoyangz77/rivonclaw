export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      probUnitsGe1: "P(units >= 1)",
      probUnitsGe3: "P(units >= 3)",
      probUnitsGe10: "P(units >= 10)",
      predictionModel: "Model",
      predictionScenario: "Scenario: {{scenario}}",
      predictedAt: "Predicted {{time}}",
      predictionStatuses: {
        OK: "OK",
        INVALID_CONTEXT: "Missing context",

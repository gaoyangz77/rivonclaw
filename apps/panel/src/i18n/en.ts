export default {
  ...
  permissions: {
    ...
    description: "DlxAI enforces file access permissions by validating all tool calls. Your workspace folder is always accessible. Add additional folders below.",
    addPath: "Add Path",
    browsePath: "Browse...",
  ...
  settings: {
    ...
    autoLaunch: {
      title: "Startup",
      toggle: "Start DlxAI on login",
      hint: "Automatically launch DlxAI when you log in to your computer.",
      failedToSave: "Failed to save startup setting: ",
    },
    telemetry: {
      title: "Telemetry & Privacy",
      description: "Help us improve DlxAI by sharing anonymous usage statistics. Your privacy is important to us.",
    ...
    dataDir: {
      ...
      hint: "The directory where agent memory, documents, and skills are stored. Changes take effect after restarting DlxAI.",
      default: "Default",
      custom: "Custom",
      current: "Current",
      change: "Change",
      reset: "Reset to default",
      restartNotice: "Restart DlxAI for the change to take effect.",
  ...
  tutorial: {
    ...
    settings: {
      ...
      welcomeBody: "This page lets you customize how DlxAI behaves. Each section controls a different aspect of the app. Let's walk through every option.",
    ...
    apps: {
      ...
      invitationCodeBody: "Your panel access token, provided during onboarding. This authenticates your DlxAI instance with the cloud service. If you have already saved one, this field can be left empty on subsequent edits.",
    ...
    account: {
      ...
      identityBody: "Your avatar (generated from your name initial), display name, and email address. The email is the one you used to sign up or log in to DlxAI.",
      logoutTitle: "Log Out",
      ...
      memberSinceBody: "The date when your account was created. This helps you track how long you have been using DlxAI.",
      ...
      modulesSectionBody: "Modules are optional feature packs that extend DlxAI with specialized capabilities. Each module unlocks additional tools, pages, and integrations tailored to a specific workflow. Enable or disable modules here to customize your workspace.",

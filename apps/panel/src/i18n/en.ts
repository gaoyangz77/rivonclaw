...
export default {
  ...
  nav: {
    ...
    affiliateHistory: "Platform collaborations",
    surfaces: "Surfaces",
    group: {
  ...
  auth: {
    ...
    browserLoginWaitingHint:
      "Approve this desktop in the secure TK Copilot page. This window will update automatically.",
  ...
  tools: {
    selector: {
      ...
      name: {
        ...
        ECOM_GET_ORDER_PRICE_DETAIL: "Get Order Price Breakdown",
        ...
        ECOM_UPDATE_ORDER_SHIPPING_INFO: "Update Order Shipping Info",
        ECOM_UPDATE_PACKAGE_SHIPPING_INFO: "Update Package Shipping Info",
        ECOM_VALIDATE_TTS_TRACKING: "Validate Tracking Number",
        ECOM_GET_FBT_WAREHOUSES: "List FBT Warehouses",
        ECOM_GET_FBT_INBOUND_ORDERS: "Get FBT Inbound Orders",
        ECOM_SEARCH_FBT_GOODS_PAGE: "Search FBT Goods",
        ECOM_SEARCH_FBT_INVENTORY_PAGE: "Search FBT Inventory",
        ECOM_SEARCH_FBT_INVENTORY_RECORD_PAGE: "Search FBT Inventory Records",
        ...
        AFFILIATE_LIST_SHOPS: "List Affiliate Shops",
        ...
        ECOM_CREATE_PRODUCT: "Create Product",
        ECOM_EDIT_PRODUCT: "Edit Product",
        ECOM_PARTIAL_EDIT_PRODUCT: "Partially Edit Product",
        ECOM_UPDATE_PRODUCT_PRICE: "Update Product Prices",
        ECOM_ACTIVATE_PRODUCTS: "Activate Products",
        ECOM_DEACTIVATE_PRODUCTS: "Deactivate Products",
        ECOM_DELETE_PRODUCTS: "Delete Products",
        ECOM_RECOVER_PRODUCTS: "Recover Deleted Products",
        ECOM_UPLOAD_PRODUCT_IMAGE: "Upload Product Image",
        ECOM_CHECK_LISTING_PREREQUISITES: "Check Listing Prerequisites",
        ECOM_CHECK_PRODUCT_LISTING: "Validate Product Listing",
        ECOM_GET_PRODUCT_CATEGORIES: "Get Product Categories",
        ECOM_RECOMMEND_PRODUCT_CATEGORY: "Recommend Product Category",
        ECOM_GET_PRODUCT_CATEGORY_ATTRIBUTES: "Get Category Attributes",
        ECOM_GET_PRODUCT_CATEGORY_RULES: "Get Category Listing Rules",
        ECOM_GET_PRODUCT_BRANDS: "Search Product Brands",
        ECOM_GET_PRODUCT_DIAGNOSES: "Get Product Diagnoses",
        ECOM_DIAGNOSE_AND_OPTIMIZE_PRODUCT: "Diagnose and Optimize Product",
        ECOM_GET_WAREHOUSES: "List Warehouses",
        ECOM_GET_PRODUCT_KNOWLEDGE: "Get Product Knowledge",
        ECOM_SET_PRODUCT_KNOWLEDGE: "Create or Update Product Knowledge",
        // E-commerce Ops — Conversations (Write)
        ECOM_MARK_CONVERSATION_READ: "Mark Read",
        ECOM_CREATE_CONVERSATION: "Create Conversation",
        ECOM_GET_CUSTOMER_SERVICE_INBOX: "Get CS Inbox",
        ECOM_CREATE_CUSTOMER_SERVICE_CONVERSATION: "Create CS Conversation",
        ECOM_SEND_CUSTOMER_SERVICE_TEXT_REPLY: "Send CS Text Reply",
        ECOM_SEND_CUSTOMER_SERVICE_CARD: "Send CS Card",
        // E-commerce Ops — Shop
        ...
        AFFILIATE_GET_BD_CONTACT: "Get Business Developer Contact",
        AFFILIATE_REPLY_UNKNOWN_SENDER: "Ask an Unknown Sender Who They Are",
        AFFILIATE_LINK_UNKNOWN_SENDER: "Link Unknown Sender to Creator",
        AFFILIATE_IGNORE_UNKNOWN_SENDER: "Ignore Unknown Sender",
        ...
        AFFILIATE_ESCALATE: "Escalate Affiliate Work",
        AFFILIATE_RESOLVE: "Resolve Affiliate Escalation",
        ...
        AFFILIATE_GET_WORK_ITEMS: "Get Affiliate Work",
        AFFILIATE_REVIEW_SAMPLE_APPLICATION: "Review Sample Application",
        AFFILIATE_SEND_CREATOR_MESSAGE: "Send Creator Message",
        AFFILIATE_STAGE_PRODUCT_MEDIA: "Attach Product Knowledge Media",
        // System tools — Files
        read: "Read File",
        write: "Write File",
        edit: "Edit File",
  ...
  shopAnalytics: {
    ...
    metrics: {
      ...
      NBFR: "Negative buyer feedback rate",
      SFCR: "Seller-fault cancellation rate",
    ...
    summary: {
      ...
      averageSpsHint: "Current score, not a historical average",
      lastObserved: "Last observed",
      trendWindow: "{{days}}-day platform trend window",
    },
    timeline: {
    ...
    market: {
      ...
      unavailable: "TikTok API unavailable",
    },
    chart: {
      trendByShop: "Trend by shop",
    ...
    availability: {
      AVAILABLE: "Live",
      MISSING_SCOPE: "Permission required",
      NOT_AUTHORIZED: "Reconnect",
      UNSUPPORTED_REGION: "Region not supported",
      UNSUPPORTED_PLATFORM: "Platform not supported",
      PLATFORM_ERROR: "Temporarily unavailable",
    },
    unavailableReasons: {
      AVAILABLE: "",
    ...
    shop: {
      ...
      aheadOfPeers: "Ahead of {{percent}}% of peers",
      ...
      diagnosis: "Diagnosis",
      method: "Metric calculation & benchmarks",
      numerator: "Numerator",
    ...
    states: {
      loading: "Loading live SPS diagnostics…",
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      workbench: {
        ...
        viewFullBundle: "View full Agent bundle",
      ...
      rejectReasons: {
        CREATOR_BLACKLISTED: "Creator blocked",
      ...
      sampleTiers: {
        ...
        SAMPLE_FULFILLED: "Sample fulfilled",
      ...
      manualTags: {
        ...
        searchPlaceholder: "Type to search or create a tag",
        noSelectable: "No other tags to add",
        createAndAdd: "Create and add “{{name}}”",
        remove: "Remove tag {{name}}",
        addSuccess: "Tag added",
        removeSuccess: "Tag removed",
        createSuccess: "Tag created and added",
        createFailed: "Failed to create the tag",
        ...
        noChanges: "No tag changes recorded yet",
        sourceHuman: "By a person",
        sourceAgent: "By the Agent",
        sourceSystem: "By the system",
        proposalSectionLabel: "Tag changes",
        proposalTarget: "on {{name}}",
        operationAdd: "Add",
      ...
      relationshipContacts: "Creator contacts",
      relationshipInspectorOverview: "Overview",
      relationshipInspectorContacts: "Contacts",
      relationshipInspectorManagement: "Management",
      ...
      relationshipPanelCommunication: "Communication history",
      relationshipPanelCollaborations: "Platform collaborations",
      relationshipPanelSamples: "Sample applications",
      ...
      messageComposerPlaceholder: "Write a creator-facing message…",
      messageComposerDefaultChannel: "Reply/default channel",
      ...
      timePassedDuration: "{{duration}} passed",
      ...
      openCreatorRelationshipWorkDetailHint:
        "Open the Creator workspace to review work, Samples, platform Collaborations, communication, and activity.",
      messageChannels: {
      ...
      agentWorkTable: {
        ...
        openDetail: "View {{creator}} work details: {{work}}",
      },
      agentWorkDetail: {
        ...
        triggerKind: "Trigger subject",
        triggerChannel: "Message channel",
        triggerShop: "Source shop",
        currentBusinessContext: "Current business state",
      ...
      businessDeveloperSearchPlaceholder: "Search BD name",
      allBusinessDevelopers: "All BDs",
      ...
      pageSubtitles: {
        NEEDS_ATTENTION:
          "Review pending decisions or inspect the complete work record produced by Affiliate Agent dispatches.",
        IN_PROGRESS:
      ...
      sampleApplication: {
        ...
        unlinkedTitle: "Sample requests not linked to a platform collaboration",
        none: "No linked sample request is available for this platform collaboration yet.",
      },
      creatorDetail: {
        profileFacts: "Profile overview",
        bio: "Marketplace bio",
        noBio: "No creator bio is available yet.",
        followers: "Followers",
        platform: "Platform",
        market: "Market",
        source: "Data source",
        sourceShop: "Performance source shop",
        preciseData: "Exact data",
      ...
      lifecycleEvents: {
        ...
        SAMPLE_APPLICATION_REJECTED: "Sample request rejected",
        SAMPLE_APPLICATION_CANCELLED: "Sample request cancelled",
        ...
        SAMPLE_SHIPPED: "Sample shipped",
        SAMPLE_DELIVERED: "Sample delivered",
        SAMPLE_DELIVERY_FAILED: "Sample delivery failed",
        TARGET_COLLABORATION_CREATED: "Target collaboration created",
        TARGET_INVITE_CREATED: "Target collaboration invitation created",
        ACTION_EXECUTED: "Action executed",
        ACTION_FAILED: "Action failed",
        CONTENT_DETECTED: "Creator content detected",
        ...
        WORK_ITEM_RESOLVED: "Agent work resolved",
      ...
      agendaSourceTypes: {
        CREATOR_CHANNEL_CONTACT: "Creator channel contact",
        PLATFORM_COLLABORATION: "Platform collaboration",
        PLATFORM_CONVERSATION_ROUTE: "Platform conversation route",
      ...
      processReasons: {
        ...
        COLLABORATION_CONTEXT_AMBIGUOUS: "Collaboration context is ambiguous",
        ...
        IDENTITY_RESOLUTION: "Creator identity needs resolution",
        MESSAGE_DELIVERY_FAILED: "Message delivery failed",
        PLATFORM_STATE_SYNC: "Waiting for platform state sync",
        PROPOSAL_REVISION_REQUESTED: "Proposal revision requested",
      ...
      proposalRecommendationTitles: {
        ADD_CREATOR_TAG: "Add the tag “{{name}}”",
        REMOVE_CREATOR_TAG: "Remove the tag “{{name}}”",
        MANAGE_CREATOR_TAG: "Apply {{count}} tag change(s)",
      ...
      policyActions: {
        MANAGE_CREATOR_TAG: "Manage creator tags",
      ...
      policies: {
        ...
        allManualTags: "Applies to all manual tags.",
        excludedManualTagsLabel: "Excluded manual tags",
        noExcludedManualTags: "No manual tag is excluded.",
        sampleTiersLabel: "Collaboration progress",
        sampleTierHint: "Exact rungs, never a threshold.",
      ...
      sampleWorkStatusLabels: {
        ...
        PLATFORM_STATUS_UNKNOWN: "Platform status unknown",
        CANCELLED: "Cancelled",
        EXPIRED: "Expired",
      },
    ...
    customerServiceWorkspace: {
      ...
      afterSales: "Returns & refunds ({{count}})",
      noAfterSales: "No return or refund request for this order.",
      afterSaleRequest: "After-sales request",
      createdAt: "Created",
      updatedAt: "Updated",
      messages: "Messages",
    ...
    shopDrawer: {
      ...
      affiliate: {
        ...
        performanceFollowUpSaveFailed: "Post-fulfillment sales follow-up could not be saved.",
        businessPrompt: "Business Prompt",
        businessPromptHint:
    ...
    inventory: {
      ...
      authorizationDomainPlaceholder: "Optional; defaults to the endpoint hostname",
      keepCredentialPlaceholder: "Leave blank to keep the stored value",
      credentialsWriteOnlyHint: "Credentials are write-only and will not be shown again.",

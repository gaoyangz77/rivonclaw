  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      workbench: {
        ...
        sampleOpen: "Pending", sampleSoftRejected: "Soft rejected", noSamples: "No Sample Applications need attention.", noSoftRejectedSamples: "No soft-rejected Sample Applications.", noMessages: "No Creator messages need attention.", expiresAt: "Expires {{value}}", pendingSince: "Pending since {{value}}", protected: "Protected", humanOnly: "Human only", agentProposal: "Agent proposal", viewFullBundle: "View full Agent bundle", sampleSyncIssue: "Sync issue", reopen: "Reopen", approveSample: "Approve", platformReject: "Reject on TikTok", softReject: "Soft reject", sampleSyncUnknown: "Platform status needs synchronization before review.", sampleReviewSaved: "Sample review saved.", rejectReason: "Reason", rejectExplanation: "Explain the reason", reviewTitles: { APPROVE: "Approve Sample Application", PLATFORM_REJECT: "Reject on TikTok", SOFT_REJECT: "Soft reject", REOPEN: "Reopen Sample Application" }, reviewDescriptions: { APPROVE: "TikTok will receive an approval after live revalidation.", PLATFORM_REJECT: "TikTok will receive a rejection after live revalidation.", SOFT_REJECT: "The seller decision is recorded locally. TikTok is not called and the application may expire naturally.", REOPEN: "Reopen this local decision if TikTok still allows review." },
      },

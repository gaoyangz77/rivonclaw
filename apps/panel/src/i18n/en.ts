export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      intelligenceUserModel: "User-level model",
      ...
      intelligenceClaimPrecisionTitle: "Higher expected sales with the same sample budget",
      intelligenceClaimPrecisionBody: "If you send the same {{count}} samples, the model-ranked creators are expected to sell {{lift}} more than historical staff choices.",
      intelligenceClaimPrecisionNeutral: "If you send the same {{count}} samples, this model run does not yet show a clear lift.",
      intelligenceClaimReachTitle: "More qualified creators at the same sales bar",
      intelligenceClaimReachBody: "At the {{bar}} expected-sales bar, the model finds {{creators}} qualified creators, including {{overlooked}} creators historical staff did not approve.",
      intelligenceClaimReachNeutral: "At the same expected-sales bar, this model run does not yet show broader qualified reach.",
      ...
      intelligenceSameBudgetStory: "{{window}} · expected sales when comparing the same {{count}} sample opportunities",
      intelligenceSameSalesBarStory: "{{window}} · creators above the same {{bar}} expected-sales bar",
      ...
      intelligenceModelQualifiedCreators: "model-qualified creators",
      ...
      intelligenceBudgetStatsTitle: "Why the model picks better creators",
      intelligenceBudgetStatsHeadline: "Same sample count, more of the model picks sit in higher-sales ranges",
      intelligenceBudgetStatsHint: "{{window}} · expected sales distribution at the same sample count.",
      intelligenceHistoricalExpectedUnits: "historical expected units",
      intelligenceModelExpectedUnits: "model expected units",
      intelligenceHistoricalApprovedExpected: "Historical staff choice · expected sales",
      intelligenceReachStatsTitle: "Who else the model can find",
      intelligenceReachStatsHeadline: "Same sales bar, more qualified creators discovered",
      intelligenceReachStatsHint: "{{window}} · creators whose expected sales meet or exceed {{bar}} units.",
      intelligenceOverlookedQualifiedCreators: "overlooked qualified creators",
      ...
      processReasons: {
        ...
        SAMPLE_SHIPPED_CONTENT_FOLLOW_UP_DUE: "Content follow-up due",
      ...
      collaborationWorkTitles: {
        ...
        SAMPLE_SHIPPED_CONTENT_FOLLOW_UP_DUE: "Follow up on missing content",
      ...
      collaborationWorkDescriptions: {
        ...
        FOLLOW_UP_CONTENT: "The collaboration is in the content stage. Follow up with the creator or confirm published content.",

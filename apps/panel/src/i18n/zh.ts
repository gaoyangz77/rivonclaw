export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      relationshipPanelCollaborations: "合作记录",
      ...
      collaborationRecordObject: "合作记录",
      ...
      historyTitle: "合作记录",
      historySubtitle: "查看店铺和达人之间的合作记录，点击单条记录可回看对话、提案和相关合作。",
    ...
    shopDrawer: {
      ...
      affiliate: {
        ...
        modelRecommendationTitle: "推荐使用 {{scope}}",
        modelRecommendationSelected: "当前已使用推荐模型",
        modelRecommendationSwitch: "建议切换",
        modelRecommendationPending: "模型推荐暂不可用",
        modelRecommendationLoading: "正在读取该店铺的模型表现数据。",
        modelRecommendationUnavailable: "刷新智能分析后，会在这里显示推荐。",

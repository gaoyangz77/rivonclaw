  ...
  ecommerce: {
    ...
    shopDrawer: {
      ...
      affiliate: {
        ...
        runProfileNone: "未选择运行配置",
        automaticModelSelection: "自动模型选择",
        automaticModelCurrent: "当前采用{{scope}}",
        automaticModelHint: "系统会为该店铺自动选择账号级、区域级或店铺级中表现最好的可用模型。",
        automaticModelProbabilityBased: "优于历史选择的概率最高",
        automaticModelFallback: "对比数据不足时使用确定性 fallback。",
        automaticModelUnavailable: "当前模型暂不可比较",

export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      intelligenceClaimPrecisionTitle: "同样样本预算下更精准",
      intelligenceClaimPrecisionBody: "在同样样本预算下，模型选择的达人预计比历史人工选择多卖 {{lift}}。",
      intelligenceClaimPrecisionNeutral: "在同样样本预算下，本次模型暂时还没有显示出明确的精准度提升。",
      ...
      intelligenceChartSameBudget: "相同通过量",
      intelligenceChartSameSalesBar: "相同预期销量门槛",
      intelligenceChartCreatorSwap: "模型会替换哪些选择",
      intelligenceSameBudgetStory: "{{window}} · 与历史团队相同的 {{count}} 个通过样本",
      ...
      intelligenceModelSelector: "预测模型",
      intelligenceHumanSelector: "历史人工",
      ...
      intelligenceBudgetStatsTitle: "精准度主张明细",
      intelligenceBudgetStatsHeadline: "样本数量相同，预期销量组合更强",
      intelligenceBudgetStatsHint: "{{window}} · 对比相同通过数量下的历史人工选择和模型排序选择。",
      intelligenceHistoricalExpectedUnits: "人工预期销量",
      intelligenceModelExpectedUnits: "模型预期销量",
      intelligenceHistoricalApprovedExpected: "历史通过 · 预期销量",
      intelligenceReachStatsTitle: "覆盖面主张明细",

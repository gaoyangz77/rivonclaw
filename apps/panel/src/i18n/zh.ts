export default {
  ...
  common: {
    ...
    cloudToolsUnavailableBody:
      "云端工具及相关 Agent 能力暂时不可用，请检查网络连接后稍后重试。",
  },
  authGate: {
    loginRequired: "需要登录",
    ...
    subscriptionRequiredDesc:
      "此功能仅面向 Pro 和 Enterprise 订阅用户开放。请升级您的套餐以继续。",
    upgradeAction: "升级套餐",
  },
  nav: {
    chat: "对话",
    ...
    shopAnalytics: "店铺分析",
    adsManagement: "广告",
    inventoryManagement: "库存",
    customerService: "客服",
    customerServiceConversations: "客服对话",
    customerServiceEscalations: "客服升级",
    customerServicePerformance: "客服绩效",
    customerServiceExperiments: "实验分析",
    affiliateManagement: "达人联盟",
    affiliateIntelligence: "智能分析",
    affiliateNeedsAttention: "工作台",
    affiliateCreators: "合作达人",
    affiliateInProgress: "进行中",
    affiliatePolicies: "安全策略",
    affiliateHistory: "平台合作",
    surfaces: "场景",
    group: {
      shopOperations: "店铺运营",
      automation: "自动化",
  ...
  chat: {
    ...
    stalledError:
      "回复中断 — 未收到最终回复。任务可能已在服务端完成，请尝试上滑查看或重新发送。",
    watchdogError:
      "5 分钟内无响应活动，连接可能已静默断开。请尝试重新发送消息。",
  ...
  providers: {
    title: "模型",
    description:
      "配置你的 LLM 提供商和 API 密钥。支持同时配置多个提供商，按需切换。",
    providerLabel: "提供商",
    apiKeyLabel: "API 密钥",
    ...
    reauthModal: {
      title: "重新认证 {{label}}",
      intro:
        "重新登录以更新此密钥的 OAuth 凭据。标签、模型和代理设置会保留，仅替换已存储的令牌。",
      ...
      autoSaving: "已授权，正在自动更换已存储的凭据…",
      starting: "启动中…",
      rotating: "正在更换凭据…",
      cancel: "取消",
      captureWarning:
        "凭据已更换，但令牌有效期未能读取。如下次请求失败，请再次重新认证。",
    },
    modelLabel: "模型",
    ...
    proxyPlaceholder:
      "http://user:pass@proxy.example.com:8080 或 socks5://user:pass@...",
    ...
    pricingCurrency: "货币",
    pricingDisclaimer:
      "以上为厂商公示的标准价格，实际费用可能因账户类型、优惠活动等因素而不同。",
    ...
    "oauthTokenHelp_openai-codex":
      "通过 OpenAI OAuth 获取的令牌，安全存储在系统钥匙串中。",
    ...
    "desc_moonshot-coding":
      "Kimi Code 编程套餐，适用于 Kimi CLI、Claude Code 等开发工具。",
    ...
    "desc_volcengine-coding":
      "火山方舟 Coding Plan 订阅，适用于 Claude Code 等开发工具。",
    ...
    hint_anthropic:
      "在 console.anthropic.com 获取 API 密钥，或运行 {{cmd}} 获取 OAuth Token。",
    hint_claude:
    ...
    "hint_zhipu-coding":
      "在 open.bigmodel.cn 获取 API 密钥，需先订阅 GLM 编程套餐。",
    ...
    "hint_moonshot-coding":
      "在 kimi.com/code 订阅后，前往控制台获取 API 密钥。",
    ...
    "hint_volcengine-coding":
      "在 volcengine.com 订阅 Coding Plan 后，前往控制台获取 API 密钥。",
  ...
  channels: {
    ...
    fieldBotTokenHintCreate:
      "从 Telegram 的 @BotFather 获取。安全存储在钥匙串中。",
    ...
    slackGroupAllowFromHint:
      "输入 Slack 成员 ID。点击用户头像 → 更多 → 复制成员 ID。",
    signalGroupAllowFromHint:
      "输入 Signal 用户手机号，使用 E.164 格式（如 +1234567890）。",
    googlechatGroupAllowFromHint:
      "输入 Google Chat 用户 ID。可在 Google 管理控制台 → 用户中查找。",
    ...
    signalAllowedGroupsHint:
      "输入 Signal 群组 ID，即 Signal 群组信息里显示的内部群组标识。",
    imessageAllowedGroupsHint:
      "输入 iMessage 群聊 ID，即 Messages 数据库中的聊天标识。",
    ...
    errorChannelNotSupported:
      "界面暂不支持通道类型 {{channelId}}。目前仅支持 Telegram。",
    errorLabel: "错误：",
    buttonCancel: "取消",
    buttonSaving: "保存中...",
    buttonUpdate: "更新",
    ...
    desc_telegram:
      "功能丰富的即时通讯应用，拥有强大的 Bot API，消息类型无限制。",
    ...
    tooltipDiscord:
      "在 discord.com/developers 创建 Application + Bot，开启 Message Content Intent",
    tooltipSlack:
      "在 api.slack.com/apps 创建 App，拿到 App Token (xapp-) 和 Bot Token (xoxb-)",
    tooltipGoogleChat:
      "Google Cloud 创建 Service Account + 配置 Chat App，需要公网 HTTPS endpoint",
    ...
    mattermostBotTokenHint:
      "在 Mattermost → 账号设置 → 安全 → 个人访问令牌 中创建",
    ...
    msteamsAppPasswordHint:
      "Azure Bot Framework App Password，安全存储在钥匙串中",
    ...
    slackBotTokenHint:
      "从 Slack 应用设置中获取的 Bot User OAuth Token。安全存储在钥匙串中。",
    slackAppToken: "App Token（可选）",
    slackAppTokenPlaceholder: "xapp-...",
    slackAppTokenHint:
      "Socket 模式需要。从 Slack 应用设置中获取的应用级令牌。安全存储在钥匙串中。",
    slackMode: "连接模式",
    ...
    // WhatsApp fields
    whatsappSetupHint:
      "WhatsApp 需要通过 CLI 进行二维码认证：openclaw channels login whatsapp",
    // Signal fields
    signalAccount: "电话号码",
    ...
    signalHttpUrlHint:
      "signal-cli-rest-api 服务器 URL。留空使用本地 signal-cli。",
    // iMessage fields
  ...
  stt: {
    ...
    enableStt: "启用语音转文字",
    enableHelp:
      "启用后，来自通道的语音消息将自动转录为文字，然后再发送给 AI 代理处理。",
    provider: "STT 服务商",
    providerGroq: "Groq (Whisper)",
    providerVolcengine: "火山引擎",
    providerHelp:
      "选择语音转文字服务商。区域感知默认：全球使用 Groq，中国使用火山引擎。",
    ...
    feature3:
      "安全的凭证存储在操作系统密钥链中（macOS Keychain / Windows DPAPI）",
  },
  extras: {
    title: "插件",
  ...
  settings: {
    ...
    app: {
      ...
      privacyMode: "隐私模式",
      privacyModeHint:
        "遮盖手机绑定二维码、店铺名称、以及商品名称和商品图片。店铺别名照常显示。适合直播或屏幕共享时使用。",
      clickToReveal: "点击显示",
    ...
    telemetry: {
      title: "遥测与隐私",
      description:
        "通过分享匿名使用统计数据帮助我们改进TK匠。我们重视您的隐私。",
      toggle: "发送匿名使用统计数据",
      ...
      consent: {
        title: "帮助改进TK匠",
        description:
          "我们收集匿名使用统计数据以改进产品。绝不收集个人信息、对话内容或 API 密钥。",
        collectLabel: "收集内容：",
  ...
  welcome: {
    ...
    createAccountDesc:
      "创建账号，如有邀请码可填写，然后连接第一家符合条件的店铺。",
    loginTitle: "老用户登录",
    loginDesc: "登录后恢复你的店铺、账单、预设和云端工作区。",
  },
  onboarding: {
    skipSetup: "跳过设置",
  ...
  crons: {
    ...
    cronInvalidFormat:
      "无效的 cron 表达式，必须包含 5 个字段：分 时 日 月 星期",
  ...
  auth: {
    ...
    loginAction: "登录",
    registerAction: "创建账户",
    switchToRegisterPrompt: "还没有账户？",
    switchToLoginPrompt: "已有账户？",
    email: "邮箱",
    password: "密码",
    inviteCode: "邀请码",
    inviteCodePlaceholder: "可选",
    inviteCodeHint: "如由代理邀请注册，可填写 6 位邀请码。",
    ...
    browserLoginWaitingHint:
      "在 TK Copilot 安全页面允许此桌面端登录，本窗口会自动更新。",
    ...
    errorInvalidInviteCode: "邀请码无效或已停用。",
    ...
    agreeTermsMiddle: "和",
    privacyPolicy: "隐私政策",
    agreeUserAgreementPrefix: "我已阅读并同意",
    userAgreement: "用户协议",
    agreeUserAgreementSuffix: "。",
    errorUserAgreementRequired: "请先同意用户协议再创建账户。",
    autoRegisterNotice:
      "该邮箱尚未注册，已为您切换到注册模式，请输入验证码后点击创建账户。",
  ...
  account: {
    ...
    plan: "套餐",
    inviteCode: "邀请码",
    inviteCodeTooltip: "邀请其他用户入驻赢取福利，具体福利政策请联系官方确认",
    subscription: "订阅",
    memberSince: "注册时间",
    status: "状态",
    seats: "席位",
    validUntil: "有效期至",
    runProfilesDesc:
      "Agent 运行的工具预设。启动聊天或定时任务时选择一个或多个。",
    defaultRunProfile: "默认运行配置",
    defaultRunProfileHint:
      "未手动选择时应用于新会话（聊天、定时任务、渠道消息）",
    noDefault: "无（仅基础工具）",
    llmKey: "LLM 密钥",
    llmKeySuspended: "已暂停",
  ...
  billing: {
    ...
    paymentRecords: "支付记录",
    noPayments: "暂无支付记录。",
    noCompletedPayments: "暂无已完成的支付记录。",
    ...
    paymentRequired: "需要开通",
    needsActivation: "需要开通",
    subscriptionStatus: "订阅状态",
    customerService: "AI 智能客服",
    customerServiceUnlimited: "AI 智能客服无限版",
    ...
    subscribeAccountPlan: "订阅",
    upgradeAccountPlan: "升级",
    chooseAccountPlan: "选择 AI 套餐",
    currentPlan: "当前套餐",
    highestPlan: "最高套餐",
    noUpgradeablePlans: "暂无可升级套餐。",
    payByCard: "信用卡（Visa、Mastercard、AMEX）",
    payByWechatAlipay: "微信 / 支付宝",
    paymentMethod: "支付方式",
    continueToPayment: "继续支付",
    manageSubscription: "管理",
    managePaymentMethod: "付款方式",
    managePaymentMethodMessage:
      "打开 Stripe 安全计费页面，更新此订阅使用的信用卡。",
    changePaymentMethod: "更换信用卡",
    cancelSubscription: "退订",
    cancelSubscriptionTitle: "确认退订？",
    cancelSubscriptionMessage: "服务会持续到 {{date}}，之后将不再续订。",
    cancelSubscriptionConfirm: "到期退订",
    renewalReminder: "此服务不会自动续订。请在 {{date}} 前续费，避免业务中断。",
    renewBefore: "{{date}} 前续费",
    renewSubscription: "续费",
    extendPrepaid: "续费",
    extendPrepaidTitle: "续费",
    extendPrepaidMessage:
      "使用微信或支付宝付款，会在 {{date}} 之后延长服务访问时间。",
    ...
    subscribeShopServices: "开通店铺服务",
    shopSubscriptionHint: "选择一个服务套餐和一家店铺，然后发起支付。",
    openServiceCheckout: "选择店铺和支付方式",
    chooseShopServicePlan: "选择服务套餐",
    selectShop: "选择店铺",
    ...
    enums: {
      ...
      entitlementCode: {
        ALLOWED: "已开通",
        PAYMENT_REQUIRED: "需要开通",
        TRIAL_EXPIRED: "试用已到期",
        QUOTA_EXCEEDED: "用量已达上限",
        PAST_DUE: "逾期",
      ...
      usageMetric: {
        LLM_TOKEN: "LLM 用量",
        CS_CONVERSATION_STARTED: "客服会话",
        ECOM_INVENTORY_ACTION: "库存操作",
        ECOM_AFFILIATE_ACTION: "达人操作",
      },
      usageWindow: {
        FIVE_HOURS: "5 小时",
        WEEK: "每周",
        MONTH: "每月",
        GRANT_LIFETIME: "权益有效期",
      },
    },
    paymentPending: {
      title: "等待支付",
      stripeHelp: "信用卡支付页已在浏览器中打开。完成支付后回到这里刷新状态。",
      lakalaHelp:
        "请使用微信或支付宝扫描二维码完成支付。系统会自动刷新状态，最多轮询 5 分钟。",
      qrAlt: "支付二维码",
      qrUnavailable: "此支付记录未返回二维码。",
      success: "支付已成功。",
      successClosing: "支付已成功。计费数据已刷新，窗口将自动关闭。",
      successCountdown: "正在刷新计费数据，窗口将在 {{count}} 秒后自动关闭。",
    },
    subscriptionStartAction: {
      SUBSCRIPTION_RESUMED: "已恢复自动续费。",
      ALREADY_ACTIVE: "订阅已生效。",
    },
    errors: {
      checkoutFailed: "支付状态更新失败：{{message}}",
      missingCheckoutUrl: "信用卡支付未返回 Checkout 链接，请刷新后重试。",
      missingQrCode: "扫码支付未返回此支付的二维码。",
      missingBillingPortalUrl: "Stripe 计费页面没有返回链接，请刷新后重试。",
      pollingExpired: "支付状态轮询已在 5 分钟后停止。你仍可手动刷新。",
    },
  },
  subscription: {
    free: "自带密钥",
  ...
  tools: {
    selector: {
      ...
      category: {
        ...
        AFFILIATE_READ: "达人管理",
        AFFILIATE_SEARCH: "达人管理",
        AFFILIATE_ACTION: "达人管理",
        AFFILIATE_APPROVAL: "达人管理",
        SYSTEM: "系统工具",
        EXTENSION: "扩展工具",
        ENTITLED: "增值工具",
        fs: "文件",
      ...
      name: {
        ...
        ECOM_GET_ORDER_PRICE_DETAIL: "获取订单价格明细",
        // 电商运营 — 履约
        ...
        ECOM_UPDATE_ORDER_SHIPPING_INFO: "更新订单物流信息",
        ECOM_UPDATE_PACKAGE_SHIPPING_INFO: "更新包裹物流信息",
        ECOM_VALIDATE_TTS_TRACKING: "校验物流单号",
        ECOM_GET_FBT_WAREHOUSES: "列出 FBT 仓库",
        ECOM_GET_FBT_INBOUND_ORDERS: "获取 FBT 入库单",
        ECOM_SEARCH_FBT_GOODS_PAGE: "搜索 FBT 货品",
        ECOM_SEARCH_FBT_INVENTORY_PAGE: "搜索 FBT 库存",
        ECOM_SEARCH_FBT_INVENTORY_RECORD_PAGE: "搜索 FBT 库存流水",
        // 电商运营 — 商品
        ...
        ECOM_CREATE_PRODUCT: "创建商品",
        ECOM_EDIT_PRODUCT: "编辑商品",
        ECOM_PARTIAL_EDIT_PRODUCT: "部分编辑商品",
        ECOM_UPDATE_PRODUCT_PRICE: "更新商品价格",
        ECOM_ACTIVATE_PRODUCTS: "上架商品",
        ECOM_DEACTIVATE_PRODUCTS: "下架商品",
        ECOM_DELETE_PRODUCTS: "删除商品",
        ECOM_RECOVER_PRODUCTS: "恢复已删除商品",
        ECOM_UPLOAD_PRODUCT_IMAGE: "上传商品图片",
        ECOM_CHECK_LISTING_PREREQUISITES: "检查上架前提条件",
        ECOM_CHECK_PRODUCT_LISTING: "校验商品上架信息",
        ECOM_GET_PRODUCT_CATEGORIES: "获取商品类目",
        ECOM_RECOMMEND_PRODUCT_CATEGORY: "推荐商品类目",
        ECOM_GET_PRODUCT_CATEGORY_ATTRIBUTES: "获取类目属性",
        ECOM_GET_PRODUCT_CATEGORY_RULES: "获取类目上架规则",
        ECOM_GET_PRODUCT_BRANDS: "搜索商品品牌",
        ECOM_GET_PRODUCT_DIAGNOSES: "获取商品诊断",
        ECOM_DIAGNOSE_AND_OPTIMIZE_PRODUCT: "诊断并优化商品",
        ECOM_GET_WAREHOUSES: "列出仓库",
        ECOM_GET_PRODUCT_KNOWLEDGE: "获取产品知识",
        ECOM_SET_PRODUCT_KNOWLEDGE: "创建或更新产品知识",
        // 电商运营 — 会话操作
        ECOM_MARK_CONVERSATION_READ: "标记已读",
        ECOM_CREATE_CONVERSATION: "创建会话",
        ECOM_GET_CUSTOMER_SERVICE_INBOX: "获取客服收件箱",
        ECOM_CREATE_CUSTOMER_SERVICE_CONVERSATION: "创建客服会话",
        ECOM_SEND_CUSTOMER_SERVICE_TEXT_REPLY: "发送客服文字回复",
        ECOM_SEND_CUSTOMER_SERVICE_CARD: "发送客服卡片",
        // 电商运营 — 店铺
        ...
        // 电商客服 — 升级
        CS_ESCALATE: "升级处理",
        CS_DISMISS_CONVERSATION_ESCALATIONS: "关闭会话升级",
        CS_RESPOND: "回复升级",
        ...
        AFFILIATE_LIST_OPEN_COLLABORATIONS: "列出公开合作",
        AFFILIATE_LIST_SHOP_OPEN_COLLABORATIONS: "列出店铺公开合作",
        AFFILIATE_SEARCH_MANUAL_TAGS: "搜索达人手动标签",
        AFFILIATE_LIST_SHOP_TARGET_COLLABORATIONS: "列出店铺定向合作",
        AFFILIATE_GET_SAMPLE_APPLICATION: "获取单个样品申请",
        AFFILIATE_GET_RELATIONSHIP_TIMELINE: "获取达人关系时间线",
        AFFILIATE_LIST_CREATOR_COLLABORATIONS: "列出达人合作",
        AFFILIATE_LIST_CREATOR_SAMPLE_APPLICATIONS: "列出达人样品申请",
        ...
        AFFILIATE_GET_BD_CONTACT: "获取商务联系方式",
        AFFILIATE_REPLY_UNKNOWN_SENDER: "询问陌生发信人身份",
        AFFILIATE_LINK_UNKNOWN_SENDER: "将陌生发信人关联到达人",
        AFFILIATE_IGNORE_UNKNOWN_SENDER: "忽略陌生发信人",
        AFFILIATE_MANAGE_OPEN_COLLABORATION: "管理公开合作",
        AFFILIATE_MANAGE_TARGET_COLLABORATION: "管理定向合作",
        AFFILIATE_RESOLVE_WORK_ITEM: "处理达人任务",
        AFFILIATE_ESCALATE: "升级达人任务",
        AFFILIATE_RESOLVE: "解决达人升级工单",
        ...
        AFFILIATE_GET_WORK_ITEMS: "获取达人任务",
        AFFILIATE_REVIEW_SAMPLE_APPLICATION: "审核样品申请",
        AFFILIATE_SEND_CREATOR_MESSAGE: "发送达人消息",
        AFFILIATE_STAGE_PRODUCT_MEDIA: "附加产品知识素材",
        // 系统工具 — 文件
        read: "读取文件",
        write: "写入文件",
        edit: "编辑文件",
  ...
  shopAnalytics: {
    ...
    summary: {
      ...
      averageSps: "平均 SPS",
      averageSpsHint: "当前评分，不是历史平均值",
      lastObserved: "最近观测",
      trendWindow: "平台最近 {{days}} 天趋势",
    },
    timeline: {
      title: "关于这条时间线",
    ...
    market: {
      oneShop: "1 家店铺",
      shops: "{{count}} 家店铺",
      live: "TikTok SPS 实时数据",
      unavailable: "TikTok API 不可用",
    },
    chart: {
      trendByShop: "按店铺查看趋势",
      latestObservations: "最近 {{days}} 个每日观测值",
      unsupportedTitle: "该市场暂未开放 SPS",
      autoScale: "Y 轴已按可见数据范围自动缩放",
      seriesAria: "图表序列",
      noTrendTitle: "TikTok 未返回趋势数据点",
      noTrendBody: "请查看下方店铺状态，并在 TikTok SPS 数据可用后刷新。",
      usOnlyTitle: "当前 API 仅支持美国市场",
      unsupportedBody:
        "这些店铺仅用于展示覆盖情况；系统不会为不支持的地区推断评分或诊断。",
    },
    availability: {
      AVAILABLE: "实时",
      MISSING_SCOPE: "需要权限",
      NOT_AUTHORIZED: "重新连接",
      UNSUPPORTED_REGION: "暂不支持该地区",
      UNSUPPORTED_PLATFORM: "暂不支持该平台",
      PLATFORM_ERROR: "暂时不可用",
    },
    unavailableReasons: {
      AVAILABLE: "",
      MISSING_SCOPE: "店铺授权缺少 SPS 所需权限。",
      NOT_AUTHORIZED: "请重新连接该店铺以加载 SPS 数据。",
      UNSUPPORTED_REGION: "TikTok 当前仅向美国区店铺开放 SPS API。",
      UNSUPPORTED_PLATFORM: "TikTok SPS 仅适用于 TikTok Shop 连接。",
      PLATFORM_ERROR: "TikTok SPS 数据暂时不可用，请稍后重试。",
    },
    shop: {
      noTopIssue: "未标记主要问题",
      currentTier: "当前等级",
      defaultCategory: "TikTok Shop",
      aheadOfPeers: "领先 {{percent}}% 的同类店铺",
      observed: "观测于 {{date}}",
      metricValue: "指标值",
      metricScore: "指标评分",
      status: "状态",
  ...
  tutorial: {
    ...
    shopAnalytics: {
      welcomeTitle: "店铺表现分析",
      welcomeBody: "在一个页面中按市场和店铺比较实时 SPS 健康度。",
      metricsTitle: "选择诊断指标",
      metricsBody: "切换 SPS 指标会同时刷新各市场图表和店铺诊断。",
      trendTitle: "比较店铺趋势",
      trendBody: "每条线代表一家店铺。TikTok 当前最多返回 90 个每日观测点。",
    },
    adsManagement: {
      welcomeTitle: "TikTok Ads",
      welcomeBody:
        "这个页面用于连接 TikTok Business 授权，并查看店铺的广告账户覆盖情况。",
      actionsTitle: "连接与刷新",
      actionsBody:
      ...
      shopCoverageBody:
        "这里按店铺组合展示广告覆盖状态，便于区分已覆盖、部分覆盖和未覆盖。",
    },
    providers: {
      welcomeTitle: "欢迎来到模型页面",
      welcomeBody:
        "在这里配置驱动 Agent 的 LLM 提供商。我们来逐步了解这个页面的每个部分。",
      tabBarTitle: "提供商类型",
      tabBarBody:
      ...
      providerLinksBody:
        "还没有 API 密钥？点击此链接前往提供商官网，你可以在那里注册并生成密钥。",
      advancedTitle: "高级设置",
      advancedBody:
    ...
    settings: {
      ...
      agentSectionBody:
        "这些设置控制 AI Agent 如何处理对话以及如何与浏览器交互。更改会立即生效。",
      ...
      privacyModeBody:
        "当别人能看到你的屏幕时，遮盖那些能识别你生意的信息。开启后会遮盖三类内容：绑定手机时显示的二维码、店铺名称、以及商品名称和商品图片。\n\n店铺别名不会被遮盖。给店铺设置别名后，别名照常显示，这样在共享屏幕或录屏时你仍然能分清各个店铺。\n\n这只改变显示效果，数据本身不受影响。关闭后即可恢复原样。",
    ...
    channels: {
      ...
      refreshBtnBody:
        "点击刷新所有渠道的连接状态。检查每个渠道的机器人是否正在运行且可达。",
      ...
      infoBoxTitle: "渠道信息",
      infoBoxBody:
        "选择渠道后，此区域会显示有用的设置说明，可能还包含该平台的分步教程链接。",
      accountsTableTitle: "已连接的账号",
      accountsTableBody:
        "此表格显示所有已配置的渠道账号。每行代表一个通讯平台上的机器人或连接。",
    ...
    skills: {
      ...
      paginationBody:
        "当技能数量较多时，使用分页控件浏览不同页面。点击页码或上一页/下一页按钮。",
    ...
    crons: {
      ...
      sortTitle: "排序方式",
      sortBody:
        "改变任务的排列顺序：按下次运行时间、最近更新时间或按名称字母排序。",
      addBtnTitle: "创建新任务",
      addBtnBody:
    ...
    extras: {
      ...
      sttHeadTitle: "语音转文字",
      sttHeadBody:
        "此功能将语音转换为文字，让你可以通过移动聊天渠道用语音消息与 Agent 交流。",
      sttToggleTitle: "启用语音转文字",
      sttToggleBody:
        "拨动此开关开启或关闭语音转文字。启用后需要在下方配置提供商和 API 密钥。",
      ...
      webSearchSaveBody:
        "点击保存存储网络搜索设置。你的 Agent 将在下次对话中开始使用网络搜索。",
      ...
      embeddingSaveBody:
        "点击保存存储嵌入配置。保存后，Agent 将开始从未来的对话中构建长期记忆。",
    },
    usage: {
      ...
      refreshTitle: "刷新数据",
      refreshBody:
        "点击从服务器重新加载所有用量数据。数据也会每 60 秒自动刷新。",
      todayTitle: "今日用量",
      ...
      lastUpdatedBody:
        "显示数据的最后刷新时间。如果时间看起来较旧，请点击页面顶部的刷新按钮。",
    },
    apps: {
    ...
    account: {
      ...
      surfacesHeaderBody:
        "标题和描述说明了场景的用途。右侧有创建新场景或从现有预设开始的按钮。",
    ...
    billing: {
      ...
      welcomeBody: "此页面集中展示账号 AI 订阅、店铺服务订阅和支付记录。",
      overviewTitle: "计费概览",
      overviewBody:
        "标题区域说明这里展示的计费数据。你可以在此查看当前权益并管理付费服务。",
      accountPlanTitle: "账号 AI 套餐",
      accountPlanBody:
        "这张卡片展示账号级 AI 权益、套餐状态、有效期以及通用 Agent 运行的使用限制。",
      usageTitle: "用量与套餐详情",
      usageBody:
        "用量卡片和元数据显示剩余额度、续期时间和订阅状态。这些是来自计费后端的只读快照。",
      accountActionsTitle: "账号计费操作",
      accountActionsBody:
        "当当前套餐支持时，可通过这些按钮发起结账、管理支付方式或打开计费门户。",
      ...
      shopListBody:
        "每一行汇总一个店铺已启用的付费服务、状态、续期信息和服务级操作。",
      paymentsTitle: "支付记录",
      paymentsBody:
        "已完成的付款和账单会显示在这里，方便你直接在桌面端审计近期计费活动。",
    },
    ecommerce: {
      welcomeTitle: "欢迎来到跨境电商",
      welcomeBody:
        "此页面用于管理已连接店铺、电商 AI 客服、联盟自动化和仓储集成。",
      shopsTitle: "已连接店铺",
      shopsBody:
        "店铺区域列出所有已连接的卖家账号，并提供每个店铺的主要运营入口。",
      shopActionsTitle: "店铺操作",
      shopActionsBody:
        "刷新会拉取最新店铺状态。添加店铺会启动平台 OAuth 授权流程，用于连接新的卖家账号。",
      shopTableTitle: "店铺表格",
      shopTableBody:
        "表格展示店铺身份、别名、平台、区域、授权状态、余额和行级操作。",
      shopAliasTitle: "店铺别名",
      shopAliasBody:
        "别名用于在本地重命名店铺，便于识别。按 Enter 或离开输入框即可保存。",
      shopRowActionsTitle: "行操作",
      shopRowActionsBody:
        "打开抽屉配置服务，重新授权过期令牌，或断开店铺连接。",
      wmsTitle: "仓储账号",
      wmsBody: "仓储账号将你的店铺数据连接到库存和履约系统。",
      wmsActionsTitle: "仓储操作",
      wmsActionsBody: "刷新库存状态、查看支持的 WMS 服务商，或添加仓储账号。",
      wmsTableTitle: "仓储表格",
      wmsTableBody:
        "仓储表格展示已同步仓库、端点、币种、同步时间和库存管理操作。",
      drawerTitle: "店铺抽屉",
      drawerBody:
        "店铺级配置都在抽屉中完成：概览、AI 客服、库存、联盟管理、计费和设备绑定。",
    },
    ecommerceCustomerService: {
      welcomeTitle: "欢迎来到客服工作台",
      welcomeBody: "此工作台用于监控买家会话，并处理跨店铺的 AI 升级事件。",
      tabsTitle: "工作台标签",
      tabsBody:
        "可在实时会话收件箱和升级队列之间切换。计数帮助你快速了解当前工作量。",
      filtersTitle: "筛选器",
      filtersBody:
        "按店铺、会话状态、AI 状态、升级状态和分页大小筛选，聚焦当前队列。",
      searchTitle: "搜索",
      searchBody:
        "搜索可按买家、订单或会话标识缩小队列范围。应用搜索后会刷新当前视图。",
      conversationShellTitle: "会话工作区",
      conversationShellBody: "分栏视图左侧保留队列，右侧显示所选会话详情。",
      conversationListTitle: "会话列表",
      conversationListBody:
        "每一行汇总一条买家会话，包括店铺、时间、状态、升级标记和预览文本。",
      conversationDetailTitle: "会话详情",
      conversationDetailBody:
        "详情区展示消息、摘要工具、AI 开关、人工回复控件和当前会话的元数据。",
      manualReplyTitle: "人工回复",
      manualReplyBody:
        "需要人工直接回复时使用这里。它可以与该会话的 AI 控制一起配合使用。",
      escalationQueueTitle: "升级队列",
      escalationQueueBody:
        "升级标签页列出需要审核、响应或忽略的开放/待处理事件。",
    },
    ecommerceAffiliate: {
      welcomeTitle: "欢迎来到联盟管理",
      welcomeBody: "此工作台用于在 AI 生成的联盟操作执行前进行人工审核。",
      panelTitle: "提案面板",
      panelBody: "面板包含待处理的达人或合作提案，并按店铺和达人上下文分组。",
      toolbarTitle: "工具栏",
      toolbarBody:
        "工具栏显示待处理数量、店铺筛选器和刷新按钮，用于拉取最新提案。",
      shopFilterTitle: "店铺筛选",
      shopFilterBody: "使用店铺筛选器聚焦某个卖家账号，或查看全部店铺的提案。",
      queueTitle: "提案队列",
      queueBody:
        "提案分组显示在这里。当没有等待人工审批的 AI 操作时，空状态是正常的。",
      proposalCardTitle: "提案卡片",
      proposalCardBody:
        "每张卡片说明操作类型、原因、目标 ID 和该联盟操作的策略上下文。",
      actionsTitle: "批准或拒绝",
      actionsBody: "批准会应用该提案。拒绝会记录决策并阻止自动化执行该操作。",
    },
  },
  surfaces: {
    title: "场景与运行配置",
    description:
      "场景定义了某个使用场景中可用的工具集。运行配置在场景内为具体运行选择特定工具。",
    surfacesTitle: "场景",
    refreshTools: "刷新工具",
    createSurface: "新建场景",
  ...
  tiktokShops: {
    title: "TikTok 店铺",
    description:
      "连接并管理你的 TikTok Shop 账户。为每个店铺启用 AI 智能客服。",
    connectedShops: "已连接店铺",
    connectShop: "连接店铺",
    connectShopTitle: "连接 TikTok Shop",
    connectShopDesc:
      "将在浏览器中打开 TikTok 授权页面。授权完成后，你的店铺将自动显示在此处。",
  ...
  adsManagement: {
    title: "TikTok Ads 管理",
    subtitle:
      "连接 TikTok Business 授权，并确认哪些已授权店铺能被这些广告账户覆盖。",
    connect: "连接 TikTok Ads",
    connectAdvertiser: "连接广告账户",
    ...
    emptyAdvertisersTitle: "尚未连接广告账户",
    emptyAdvertisersBody:
      "连接 TikTok Business 或 Ads Manager 后，这里会显示可访问的广告账户。",
    shopReadinessTitle: "店铺 Ads 状态",
    shopReadinessSubtitle:
      "查看每个已连接店铺的广告账户覆盖和 GMV Max 就绪状态。",
    shopCoverageTitle: "店铺广告覆盖",
    ...
    openAuthLink: "打开 TikTok Ads 授权链接",
    oauthHint:
      "请在已登录 TikTok Business Center 或 Ads Manager 账号的浏览器中打开此链接。",
    waitingAuth: "正在等待 TikTok Ads 授权...",
    oauthSuccess: "TikTok Business 连接成功。",
    oauthFailed: "启动 TikTok Ads 授权失败。",
    oauthTimeout: "授权超时。如果已经在浏览器中完成授权，请刷新此页面。",
    copyFailed: "复制授权链接失败。",
    disconnect: "断开连接",
    confirmDisconnect: "断开此广告账户？断开后 BI 同步会停止，直到重新授权。",
    disconnectSuccess: "广告账户已断开连接。",
    disconnectFailed: "断开广告账户失败。",
    columns: {
      name: "广告账户",
  ...
  ecommerce: {
    title: "店铺管理",
    subtitle: "管理已连接店铺、授权和经营服务。",
    shops: "店铺",
    shopsSubtitle: "已连接店铺与服务状态。",
    productCard: {
      openProductDetail: "查看商品详情",
      enlargeProductImage: "查看商品大图",
      productDetailTitle: "商品详情",
      loadingProduct: "正在加载商品详情……",
      productUnavailable: "暂时无法加载商品详情。",
      imagePreview: "商品图片预览",
      price: "价格",
      status: "状态",
      brand: "品牌",
    ...
    customerServicePerformance: {
      title: "客服绩效",
      subtitle:
        "查看响应速度、升级压力、满意度和客服工作量，判断客服团队是否跟得上业务节奏。",
      allShops: "全部店铺",
      shopFilter: "店铺",
      timeRange: "时间范围",
      loadFailed: "加载绩效数据失败",
      ...
      dailyTable: "每日绩效",
      scopeSummary:
        "{{start}} 至 {{end}}，覆盖 {{shops}} 个店铺。表格显示该时间范围内全部日期。",
      tabs: {
        label: "绩效视图",
        history: "历史数据",
        realtime: "实时数据",
      ...
      metrics: {
        active: "活跃会话",
        sessionFlow: "结束会话",
        newSessions: "{{value}} 个新增会话",
        endedSessions: "结束会话",
        endedMessages: "{{count}} 条结束消息",
        newConversations: "{{count}} 个新增",
        escalations: "升级会话",
        resolved: "{{value}} 个已处理",
        resolvedWithRate: "{{value}} 个已处理 · 处理率 {{rate}}",
        satisfaction: "满意度",
    ...
    customerServiceExperiments: {
      eyebrow: "客户服务 · 实验分析",
      title: "客服实验分析",
      subtitle: "查看未付款订单随机实验的实时信号、成熟进度与最终结果。",
      tabs: { label: "实验视图", realtime: "实时实验", history: "历史实验" },
      filters: {
        shop: "店铺",
        type: "实验类型",
        allShops: "全部店铺",
      ...
      status: {
        RUNNING: "运行中",
        STOPPED_MATURING: "已结束",
        FINAL: "已完成",
      },
      dataStatus: { PROVISIONAL: "实时预估", FINAL: "最终结果" },
      actions: {
        NO_REACHOUT: "不触达",
        CONTINUE: "正常触达",
        APPLY_CONFIG: "应用配置",
      ...
      metrics: {
        PAYMENT_WITHIN_WINDOW: "成熟窗口内支付率",
        GMV_PER_ASSIGNED_ORDER: "每个分组订单 GMV",
        UNITS_PER_ASSIGNED_ORDER: "每个分组订单销量",
        PAYMENT_LATENCY: "支付耗时",
        MESSAGE_SEND_FAILURE_RATE: "消息发送失败率",
      },
      ranges: {
        REALTIME_6H: "最近 6 小时",
        REALTIME_24H: "最近 24 小时",
        REALTIME_72H: "最近 72 小时",
        DAILY_30D: "最近 30 天",
        DAILY_90D: "最近 90 天",
      },
      kpis: {
      ...
      configurationTitle: "{{variant}} 触达配置",
      configurationSubtitle:
        "该实验方案分组时固定使用的触达计划，不受店铺后续配置修改影响。",
      stageLabel: "第 {{index}} 阶段",
      enabledStage: "已启用",
      disabledStage: "未启用",
      afterOrder: "下单后 {{minutes}} 分钟",
      messageTemplate: "触达消息模板",
      configurationUnavailable: "暂时无法读取这场历史实验的配置快照。",
      analysis: "结果信号",
      comparisons: "统计对比",
      comparisonHint: "仅展示随机实验对比；队列成熟前，实时结果仍可能变化。",
      noTrend: "该时间范围内暂无趋势数据。",
      noComparison: "当前还没有可用的统计对比。",
      awaitingMaturityTitle: "正在等待首批订单成熟",
      ...
      comparisonAwaitingBody:
        "对照组与触达组都产生成熟样本后才会生成统计对比。下一批预计在 {{time}} 左右成熟。",
      curve: {
        paymentProgress: "支付进程",
        metricTrend: "指标趋势",
        estimatorLabel: "支付进程估计方式",
        modelEstimator: "模型信号",
        modelEstimatorHint: "触达前共享自然付款风险率",
        rawEstimator: "原始阶梯",
        ...
        noExposureBody:
          "当前曲线仅反映触达前的自然支付与取消，暂时不能用于评价触达效果。",
        tooltipCounts:
        ...
        atRiskDefinition:
          "风险集：到该时间点仍未支付且未取消、之后仍可能进入任一结果的订单。",
        coverageDefinition:
          "覆盖：已观察到该时间点，或此前已产生支付/取消结果的分组订单占比。",
        endpointCancelled: "终点已取消 {{value}}%",
        endpointStillUnpaid: "终点仍未支付 {{value}}%",
        endpointDirectional: "终点样本仍不足，仅显示方向性趋势",
        preparingTitle: "正在生成首批支付进程估计",
        preparingBody: "分组进入数据仓库后，五分钟数据管道会生成实时预估曲线。",
        loadFailed: "支付进程曲线加载失败",
        retry: "重试",
        controlLabel: "对照组 · 不触达",
      },
      insufficient: "样本不足",
      ready: "可分析",
      table: {
    ...
    affiliateWorkspace: {
      workbench: {
        title: "工作台",
        subtitle: "集中审核 Agent 工作、样品申请与达人消息。",
        tabs: {
          pendingAgent: "待人工审核",
          allAgent: "全部 Agent 工作",
          samples: "待处理申样",
          messages: "待处理消息",
        },
        sampleOpen: "待处理",
        sampleSoftRejected: "已忽略",
        noSamples: "目前没有待处理的样品申请。",
        noSoftRejectedSamples: "目前没有已忽略的样品申请。",
        noMessages: "目前没有待处理的达人消息。",
        expiresAt: "{{value}} 到期",
        pendingSince: "自 {{value}} 起待处理",
        protected: "受保护",
        humanOnly: "仅人工",
        agentProposal: "Agent 提案",
        viewFullBundle: "查看完整 Agent Bundle",
        sampleSyncIssue: "同步异常",
        reopen: "重新打开",
        approveSample: "同意",
        platformReject: "拒绝",
        softReject: "忽略",
        sampleSyncUnknown: "平台状态同步异常，暂时不能审核。",
        sampleReviewSaved: "申样处理已保存。",
        rejectReason: "拒绝原因",
        ...
        reviewDescriptions: {
          APPROVE: "实时校验后将在 TikTok 同意该申请。",
          PLATFORM_REJECT: "实时校验后将在 TikTok 拒绝该申请。",
          SOFT_REJECT: "忽略后不再继续审查该样品申请，等待其自然过期，不会直接在 TikTok 上拒绝；到期前可重新打开。",
          REOPEN: "若 TikTok 仍允许审核，则重新打开本地决定。",
        },
      },
      rejectReasons: {
        CREATOR_BLACKLISTED: "达人已屏蔽",
        DUPLICATE_APPLICATION: "重复申请",
        LOW_EXPECTED_SALES: "预期销量低",
        NOT_MATCH: "不匹配",
        OFFLINE: "已下线",
        OTHER: "其他",
        OUT_OF_STOCK: "缺货",
      ...
      sampleTiers: {
        SAMPLE_SHIPPED: "已发样",
        SAMPLE_DELIVERED: "已收样",
        SAMPLE_FULFILLED: "已履约",
        ATTRIBUTABLE_ORDER: "已出单",
      },
      sampleTierColumnLabel: "合作进度",
      sampleTierColumnHint: "该达人在所有店铺中达到的最高合作档位",
      sampleTierFilterLabel: "合作进度",
      sampleTierFilterHint: "筛选当前处于所选合作档位的达人。",
      sampleTierEmpty: "暂无合作进度",
      ...
      shopSampleTierFilterLabel: "店内合作进度",
      ...
      manualTags: {
        ...
        searchLabel: "搜索标签",
        searchPlaceholder: "输入以搜索或新建标签",
        noSelectable: "没有可添加的其他标签",
        createAndAdd: "新建并添加“{{name}}”",
        remove: "移除标签 {{name}}",
        addSuccess: "标签已添加",
        removeSuccess: "标签已移除",
        createSuccess: "标签已新建并添加",
        createFailed: "新建标签失败",
        rename: "重命名标签 {{name}}",
        renameLabel: "重命名“{{name}}”",
        renamePlaceholder: "新的标签名称",
        renameScopeWarning:
          "该标签在整个账号内共享，重命名后所有带此标签的达人都会同步更新。",
        renameConfirm: "重命名标签",
        renameSuccess: "标签已重命名",
        renameFailed: "重命名标签失败",
        renameDuplicate: "已存在名为“{{name}}”的标签，请换一个名称。",
        updateFailed: "更新标签失败",
        lastChangeAdded: "最近变更：{{time}} 添加标签 · {{source}}",
        lastChangeRemoved: "最近变更：{{time}} 移除标签 · {{source}}",
        noChanges: "暂无标签变更记录",
        sourceHuman: "人工操作",
        sourceAgent: "由 Agent 操作",
        sourceSystem: "系统记录",
        proposalSectionLabel: "标签变更",
        proposalTarget: "作用于 {{name}}",
        operationAdd: "添加",
        operationRemove: "移除",
        deletedTag: "已删除的标签",
      },
      creatorSearchPlaceholder: "搜索昵称、账号或达人 ID",
      creatorLatestWork: "最近合作",
      creatorLastInteraction: "最近互动",
      creatorActiveCollaborations: "{{count}} 个活跃合作",
      creatorCooperationShops: "合作店铺",
      creatorFollowerCount: "{{value}} 粉丝",
      creatorFollowerDataPending: "粉丝数据待同步",
      creatorNeedsAttention: "需处理",
      creatorStable: "正常推进",
      creatorPendingProposal: "待审批提案",
      creatorSampleStatus: "样品状态",
      creatorLifecycle: "关系阶段",
      creatorUnknownStage: "未知阶段",
      creatorRelationshipWorkPrimaryObject: "合作记录",
      creatorRelationshipPrimaryObject: "达人关系",
      creatorRelationshipWorkItems: "合作记录",
      creatorIdentityObject: "达人身份",
      creatorIdentityId: "身份系统 ID",
      creatorBlocked: "已屏蔽",
      relationshipShopStates: "店铺状态",
      relationshipActiveCollaborations: "活跃合作",
      relationshipTagCount: "{{count}} 个标签",
      relationshipWorkCollaborationCount: "{{count}} 个合作",
      ...
      relationshipWorkbenchSubtitle:
        "用于查看达人资料、沟通记录、合作推进和操作历史的工作面板。",
      relationshipInformation: "达人关系信息",
      relationshipContacts: "达人联系方式",
      relationshipInspectorOverview: "概览",
      relationshipInspectorContacts: "联系方式",
      relationshipInspectorManagement: "关系管理",
      relationshipProfileSummary: "达人资料简略版",
      relationshipCurrentDecision: "当前待办",
      relationshipPanelCurrentWork: "当前待办",
      relationshipPanelCommunication: "沟通记录",
      relationshipPanelCollaborations: "平台合作",
      relationshipPanelSamples: "样品申请",
      relationshipPanelPlatformCollaborations: "平台合作",
      relationshipProposalHistory: "提案历史",
      platformCollaborationTargetMembership: "Target Collaboration 成员",
      platformCollaborationSampleReference: "由样品申请引用",
      selectMessageShop: "发送前请选择店铺",
      messageSubmitted: "消息已提交",
      messageComposerTitle: "回复达人",
      messageComposerPlaceholder: "输入面向达人的消息…",
      messageComposerDefaultChannel: "回复/默认渠道",
      messageComposerEmailSubject: "主题（新邮件线程必填）",
      messageComposerAddFiles: "添加文件",
      messageComposerInline: "内嵌",
      messageComposerPartsHint:
        "支持 1–10 个有序文本/文件部分；不会跨渠道降级发送",
      messageComposerAttachmentCount: "已添加 {{count}} 个附件",
      creatorActiveSamples: "{{count}} 个活跃样品",
      creatorActivePlatformCollaborations: "{{count}} 个活跃平台合作",
      creatorLastContactedAt: "最近联系",
      creatorLastBusinessActivityAt: "最近业务活动",
      relationshipPanelActivity: "操作历史",
      timePassed: "时间经过",
      timePassedDuration: "已过去 {{duration}}",
      timePassedDaysHours: "{{days}} 天 {{hours}} 小时",
      timePassedDays: "{{days}} 天",
      timePassedHours: "{{hours}} 小时",
      timePassedHint: "时间线项目之间经过的时间；筛选范围外可能仍有事件。",
      relationshipNoCurrentWork: "暂无待办",
      relationshipNoCurrentWorkHint:
        "这个达人关系当前没有待审批提案或人工处理任务。",
      relationshipNeedsManualReview:
        "这个达人关系需要员工先复核，再决定下一步。",
      relationshipAcrossShops: "跨店铺",
      relationshipCommunicationHint:
        "汇总可用的店铺后台、平台私信、WhatsApp 和 Email 记录。",
      noRecentContact: "暂无最近联系",
      relationshipMoreShopStates: "另有 {{count}} 个店铺状态",
      relationshipWorkUnread: "未读",
      relationshipWorkMoreCollaborations: "另有 {{count}} 个合作",
      relationshipWorkPlatformChat: "对话",
      relationshipWorkLastInbound: "最近达人消息",
      relationshipWorkLastOutbound: "最近商家回复",
      relationshipWorkContext: "记录上下文",
      relationshipWorkAmbiguousCollaborations: "可能关联的合作",
      relationshipWorkNoCollaborations: "该达人暂无关联的平台合作。",
      ...
      historyTypes: {
        PLATFORM_CHAT_MESSAGE: "平台私信",
        WHATSAPP_MESSAGE: "WhatsApp 消息",
        EMAIL_MESSAGE: "Email 消息",
        MESSAGE_DELIVERY: "消息发送",
        SAMPLE_APPLICATION_RECORD: "样品申请",
        ACTION_PROPOSAL: "动作提案",
        LIFECYCLE_EVENT: "系统事件",
      },
      historyActors: {
        CREATOR_ACTION: "达人动作",
        STAFF_ACTION: "员工动作",
      ...
      latestRecordLabel: "最新记录",
      viewDetails: "查看详情",
      emptyCreators: "这个店铺还没有合作达人。",
      historyTitle: "平台合作",
      historySubtitle:
        "查看 TikTok Open 与 Target Collaboration 平台对象、状态和关联商品。",
      ...
      agentWorkTable: {
        ...
        moreShops: "+{{count}} 家店铺",
        openDetail: "查看 {{creator}} 的工作详情：{{work}}",
      },
      agentWorkDetail: {
        eyebrow: "AFFILIATE AGENT",
        title: "工作详情",
        openRelationship: "达人工作区",
        contextEyebrow: "决策依据",
        contextTitle: "审核上下文",
        contextSubtitle:
          "还原 Agent 生成这项工作时可见的关系信息，帮助判断当前动作是否合理。",
        contextAsOf: "Agent 上下文截至 {{time}}",
        triggerContext: "本次工作的触发来源",
        triggerWorkKind: "工作场景",
        triggerKind: "触发对象",
        triggerChannel: "消息渠道",
        triggerShop: "来源店铺",
        currentBusinessContext: "当前业务状态",
        currentBusinessContextHint: "当前数据",
        activeSampleApplications: "进行中样品申请",
        bundledMessage: "同时发送给达人的回复",
        bundledMessageUnavailable:
          "这项工作包含消息回复，但当前记录中没有可展示的文字内容。",
        previousAgentWork: "过往 Agent 判断",
        recentContext: "Agent 当时可见的最近记录",
        contextLoadFailed: "暂时无法加载关系上下文。",
        noRecentContext: "Agent 处理前没有可展示的关系记录。",
      },
      revisionHistory: {
        title: "重写历史",
        hint: "这次 Agent 工作从初版到当前版本的完整记录。",
        versionCount: "V{{version}} · 共 {{count}} 版",
      },
      collaborationWorkQueueTitle: "待人工处理的合作",
      collaborationWorkQueueHint:
        "没有待审批提案的合作事项。员工需要自行判断下一步如何处理。",
      collaborationWorkQueueShortTitle: "合作处理",
      pagination: "合作记录分页",
      pageSummary: "显示 {{start}}-{{end}} / 共 {{total}} 条",
      page: "第 {{page}} / {{pages}} 页",
      prevPage: "上一页",
      nextPage: "下一页",
      jumpPageAria: "跳转到合作记录页码",
      jumpToPage: "跳到",
      markStaffHandled: "已在平台处理",
      staffActionHandled: "已标记为处理完成",
      staffActionHandledNote: "员工已在外部完成该达人合作事项。",
      mlInsightsTitle: "智能分析",
      mlInsightsHint:
        "查看模型如何发现更高潜力达人，并与历史人工放样选择进行对比。",
      mlInsightsShortTitle: "智能分析",
      intelligenceKicker: "达人机会模型",
      intelligenceAllShops: "全部达人联盟店铺",
      intelligenceScopeSelector: "智能分析范围",
      intelligenceRefresh: "刷新分析",
      intelligenceUserModel: "全局视图",
      intelligenceModelReady: "模型已就绪",
      intelligenceModelsReady: "{{count}} 个模型已就绪",
      intelligenceNoModel: "暂无模型",
      intelligenceModelUnavailable: "数据未加载",
      intelligenceModelUnavailableHint:
        "模型数据暂时没有加载成功。请稍后刷新分析。",
      intelligenceModelSourceSelector: "该店铺使用的模型",
      intelligenceAccountModel: "账号模型",
      intelligenceAccountModelHint: "使用该账号下跨店铺的达人历史。",
      intelligenceRegionModel: "区域模型",
      intelligenceRegionModelHint: "使用该账号下同一区域店铺的达人历史。",
      intelligenceStoreModel: "店铺模型",
      intelligenceStoreModelHint: "只使用该店铺自己的达人历史。",
      intelligenceRecommendedModel: "推荐",
      intelligenceConfidenceHigh: "高置信度",
      intelligenceConfidenceHighHint:
        "这个提升在当前留出测试窗口中较稳定，可以作为主要参考。",
      ...
      intelligenceSameSalesBarStory:
        "{{window}} · 达到或超过同一个 {{bar}} 件预测销量门槛的达人",
      ...
      intelligenceHumanQualifiedCreators: "历史通过且高于门槛",
      intelligenceFoundCreators: "被漏掉的高潜力达人",
      intelligenceSavedSamples: "可过滤的低优先级批准",
      intelligenceApprovalBar: "隐含销量门槛",
      ...
      intelligenceReachStatsTitle: "还有哪些达人值得看",
      intelligenceReachStatsHeadline: "销量门槛相同，模型标记出更大的机会池",
      intelligenceReachStatsHint:
        "{{window}} · 预测销量达到或超过 {{bar}} 件的达人。",
      ...
      intelligenceHumanQualifiedExpected: "历史高于门槛 · 预期销量",
      ...
      mlEstimatedUnits: "预估销量",
      mlModelExpected: "模型排序预期销量",
      mlModelExpectedHint:
        "如果模型选择与历史员工相同数量的样品，预计可获得的总销量。",
      mlHumanExpected: "人工选择预期销量",
      mlHumanExpectedHint: "历史员工批准的申请在当前模型下预计可获得的总销量。",
      mlDiscoveredCreators: "额外发现的高潜力达人",
      mlDiscoveredCreatorsHint:
        "模型会选择、但历史员工拒绝的申请；这是反事实估计。",
      mlFilteredApproved: "模型会过滤的人工通过",
      mlFilteredApprovedHint:
        "同等放样数量下，模型不会优先选择的历史人工批准申请。",
      mlBudgetThreshold: "校准阈值",
      mlBudgetThresholdBody:
        "按照历史通过量校准，隐含的最低预期销量约为 {{value}} 件。",
      ...
      businessDeveloperFilter: "BD 筛选",
      businessDeveloperSearchPlaceholder: "搜索 BD 名字",
      allBusinessDevelopers: "全部 BD",
      statusFilter: "状态筛选",
      subStatusFilter: "子状态筛选",
      allSubStatuses: "全部子状态",
      noSubStatus: "无子状态",
      typeFilter: "类型筛选",
      searchFilter: "搜索",
      itemCount: "{{count}} 项",
      ...
      productIdLabel: "商品",
      productContextConfirmed: "已关联商品",
      productContextMissing: "尚无确定合作商品",
      productContextMissingHint: "请让达人申请样品，或先确认本次合作商品。",
      productIdShort: "商品 {{productId}}",
      actionProductNotConfirmed:
        "动作引用了商品 {{productId}}，但该合作尚未绑定这个商品。",
      copyFailed: "复制 ID 失败。",
      copyCreatorHandle: "复制 TikTok 账号",
      creatorHandleCopied: "已复制账号",
      copyCreatorName: "点击复制完整达人昵称",
      creatorNameCopied: "已复制达人昵称",
      creatorPlatformIdLabel: "平台 ID",
      copyCreatorPlatformId: "复制平台 ID",
      creatorPlatformIdCopied: "已复制平台 ID",
      copySystemId: "复制系统 ID",
      systemIdCopied: "已复制系统 ID",
      copyPlatformId: "复制平台 ID",
      platformIdCopied: "已复制平台 ID",
      copyRelationshipWorkSystemId: "复制系统 ID",
      copyProductPlatformId: "复制商品平台 ID",
      copySamplePlatformId: "复制样品平台 ID",
      copyDebugId: "复制系统 ID",
      debugIdCopied: "已复制系统 ID",
      ...
      conversation: {
        ...
        loadOlder: "加载更早消息",
        replyLabel: "回复达人",
        replyPlaceholder: "输入要发送给达人的消息...",
        replyActorHint: "这条消息会以员工身份发送并记录到合作历史。",
        sendReply: "发送回复",
        replySent: "已发送回复",
        replyFailed: "回复发送失败",
        replyUnavailable: "缺少对话或达人身份，暂时无法发送回复。",
        ...
        productCardLabel: "商品卡片",
        sampleApplicationCardLabel: "样品申请卡片",
        sampleApplicationCardTitle: "样品申请",
        targetCollaborationCardLabel: "合作邀请卡片",
        targetCollaborationCardTitle: "合作邀请",
        collaborationId: "合作 ID",
      ...
      sampleApplication: {
        ...
        productId: "商品 ID",
        collaborationId: "合作 ID",
        openCollaborationId: "公开合作 ID",
        targetCollaborationId: "定向合作 ID",
        contentCount: "已观察内容",
        contentProgress: "内容发布",
        contentProgressValue: "{{count}} 条",
        shippingProgress: "样品物流",
        noTrackingYet: "暂无物流",
        latestContent: "最新内容 ID",
        latestContentAt: "最新内容时间",
        latestContentViews: "最新内容播放",
        tracking: "物流单号",
        carrier: "承运商",
        shippedAt: "发货时间",
        deliveredAt: "送达时间",
        updatedAt: "更新时间",
        unlinkedTitle: "未关联平台合作的样品申请",
        none: "这条平台合作暂未关联样品申请。",
      },
      creatorDetail: {
        profileFacts: "资料概览",
        ...
        preciseData: "精确数据",
        lastUpdated: "资料更新时间",
        marketplacePerformance: "平台表现",
        totalGmv: "总 GMV",
        videoGmv: "短视频 GMV",
        liveGmv: "直播 GMV",
        gpm: "千次曝光 GMV",
        unitsSold: "售出件数",
        promotedProducts: "带货商品数",
        ecVideos: "带货视频数",
        ecLives: "带货直播数",
        ...
        identifiers: "身份信息",
        tiktokHandle: "TikTok 账号",
        creatorImId: "达人 IM ID",
        profileUri: "资料 URI",
        creatorSignals: "达人信号",
      ...
      activity: {
        loadOlder: "加载更早操作记录",
        staffDecision: "员工备注：{{note}}",
        executedAt: "执行时间：{{time}}",
        executionFailed: "执行失败：{{error}}",
        proposalActionType: "动作类型：{{actionType}}",
        proposalStepCount: "{{count}} 个执行步骤",
        stageTransition: "阶段变化：{{from}} → {{to}}",
        eventRecorded: "事件已记录。",
      },
      lifecycleEvents: {
        AFFILIATE_ONBOARDING_COMPLETED: "达人联盟初始化完成",
        BD_ACCOUNT_BOUND: "绑定 BD 渠道账号",
        BD_ACCOUNT_TRANSFERRED: "转移 BD 渠道账号",
        BD_ACCOUNT_UNBOUND: "解绑 BD 渠道账号",
        BUSINESS_DEVELOPER_ARCHIVED: "归档业务负责人",
        BUSINESS_DEVELOPER_CREATED: "创建业务负责人",
        BUSINESS_DEVELOPER_RESTORED: "恢复业务负责人",
        BUSINESS_DEVELOPER_UPDATED: "更新业务负责人",
        CANDIDATE_QUALIFIED: "达人候选通过筛选",
        CHANNEL_CONTACT_CREATED: "创建达人渠道联系方式",
        CHANNEL_CONTACT_UPDATED: "更新达人渠道联系方式",
        PROPOSAL_CREATED: "创建提案",
        PROPOSAL_REVISION_REQUESTED: "已请求重写提案",
        PROPOSAL_IGNORED: "已忽略提案",
        PROPOSAL_APPROVED: "提案已同意",
        PROPOSAL_REJECTED: "提案已拒绝",
        PROPOSAL_SUPERSEDED: "提案已被新信息替代",
        PROPOSAL_EXPIRED: "提案已失效",
        ...
        RELATIONSHIP_BD_ASSIGNED: "分配达人关系负责人",
        MESSAGE_RECEIVED: "收到消息",
        MESSAGE_SENT: "发送消息",
        COLLABORATION_CREATED: "发现平台合作",
        COLLABORATION_CLOSED: "关闭合作记录",
        COLLABORATION_FIRST_OBSERVED: "首次发现平台合作",
        COLLABORATION_TERMINAL_STATE_FIRST_OBSERVED: "首次发现合作已结束",
        CREATOR_PROTECTION_ADDED: "添加达人关系保护",
        CREATOR_PROTECTION_MERGED: "合并达人关系保护",
        CREATOR_PROTECTION_REMOVED: "移除达人关系保护",
        CREATOR_PROTECTION_UPDATED: "更新达人关系保护",
        SAMPLE_APPLICATION_SUBMITTED: "达人提交样品申请",
        SAMPLE_APPLICATION_APPROVED: "同意样品申请",
        SAMPLE_APPLICATION_REJECTED: "拒绝样品申请",
        SAMPLE_APPLICATION_CANCELLED: "样品申请已取消",
        SAMPLE_APPLICATION_FIRST_OBSERVED: "首次发现样品申请",
        SAMPLE_APPLICATION_STATE_OBSERVED: "样品申请状态更新",
        SAMPLE_APPLICATION_TERMINAL_STATE_FIRST_OBSERVED: "首次发现样品申请已结束",
        SAMPLE_COLLABORATION_LINK_CONFLICT_OBSERVED: "发现样品合作关联冲突",
        SAMPLE_COMMISSION_RATE_CONFLICT_OBSERVED: "发现样品佣金率冲突",
        SAMPLE_APPROVED: "同意样品申请",
        SAMPLE_REJECTED: "拒绝样品申请",
        SAMPLE_SHIPPED: "样品已发货",
        SAMPLE_DELIVERED: "样品已送达",
        SAMPLE_DELIVERY_FAILED: "样品配送失败",
        TARGET_COLLABORATION_CREATED: "创建定向合作",
        TARGET_INVITE_CREATED: "创建定向合作邀请",
        ACTION_EXECUTED: "动作已执行",
        ACTION_FAILED: "动作执行失败",
        CONTENT_DETECTED: "发现达人内容",
        STAGE_CHANGED: "达人关系阶段已更新",
        WORK_ITEM_REQUEUED: "Agent 工作已重新排队",
        WORK_ITEM_RETRY_REQUESTED: "已请求重试 Agent 工作",
        WORK_ITEM_RESOLVED: "Agent 工作已处理",
        STAFF_MARKED_HANDLED: "员工标记已处理",
        WORK_RESOLVED: "工作项已处理",
      },
      sections: {
        NEEDS_ATTENTION: "待处理",
        IN_PROGRESS: "进行中",
      ...
      sectionHints: {
        NEEDS_ATTENTION:
          "需要员工审批、人工跟进，或正在等待 Agent 处理的达人事项。",
        IN_PROGRESS: "已经进入合作流程，但当前不需要员工立刻操作的达人合作。",
        HISTORY: "已执行、已拒绝、平台事件和 Agent 直接完成的动作记录。",
      },
      summary: {
        needsAttentionHint: "审批与人工跟进",
        inProgressHint: "等待达人或平台",
        historyHint: "最近处理记录",
      },
      attentionFilters: {
        ALL: "全部",
        ...
        STAFF_ACTION_REQUIRED: "员工处理",
      },
      empty: {
        NEEDS_ATTENTION: "当前没有需要处理的达人事项。",
        IN_PROGRESS: "当前没有进行中的达人合作。",
        HISTORY: "暂无达人处理历史。",
      },
      emptyHistory: "当前筛选条件下没有合作记录。",
      emptyApprovals: "当前没有等待审批的动作提案。",
      emptyCollaborationWork: "当前没有需要人工接手处理的合作。",
      emptyProposalEntities: "当前筛选条件下没有动作提案。",
      loadingEntities: "正在读取达人合作数据...",
      proposalFilters: {
        PENDING: "待审批",
        ALL: "全部",
        APPROVED: "已同意",
      ...
      collaborationFilters: {
        ...
        ALL: "全部",
        NEED_PROCESS: "待处理",
        AGENT_REQUIRED: "需要 Agent 处理",
        AGENT_NEEDED: "等待 Agent",
        WAITING_STAFF: "等待员工",
        STAFF_REQUIRED: "需要员工处理",
        STAFF_NEEDED: "等待员工",
        WAITING_APPROVAL: "等待审批",
        WAITING_EXTERNAL: "等待外部响应",
        WAITING_CREATOR: "等待达人",
      ...
      agendaSourceTypes: {
        CREATOR_CHANNEL_CONTACT: "达人渠道联系",
        PLATFORM_COLLABORATION: "平台合作",
        PLATFORM_CONVERSATION_ROUTE: "平台会话渠道",
        PROPOSAL: "动作提案",
        RELATIONSHIP: "达人关系",
        SAMPLE_APPLICATION: "样品申请",
      ...
      processReasons: {
        ...
        COLLABORATION_CONTEXT_AMBIGUOUS: "合作上下文不明确",
        ...
        IDENTITY_RESOLUTION: "达人身份待确认",
        MESSAGE_DELIVERY_FAILED: "消息发送失败",
        PLATFORM_STATE_SYNC: "等待平台状态同步",
        PROPOSAL_REVISION_REQUESTED: "提案需要重写",
        STAFF_REVIEW_REQUESTED: "需要人工判断下一步",
        AGENT_RUN_FAILED: "Agent 处理失败",
        TARGET_COLLABORATION_ACCEPTED: "定向合作已接受",
        CONTENT_PUBLISHED: "内容已发布",
        ORDER_ATTRIBUTED: "已归因订单",
        PROPOSAL_WAITING_APPROVAL: "提案等待审批",
      ...
      itemKinds: {
        ...
        MANUAL_FOLLOW_UP: "人工跟进",
        STAFF_ACTION_REQUIRED: "员工处理",
        AGENT_WORK_PENDING: "Agent 处理中",
        RELATIONSHIP_IN_PROGRESS: "进行中",
        ACTION_EXECUTED: "已执行",
        ACTION_REJECTED: "已拒绝",
        PLATFORM_EVENT: "平台事件",
      },
      requiredActions: {
        ...
        COMPLETE_COLLABORATION_TASK: "处理合作任务",
        REVIEW_COLLABORATION: "复核合作",
        RESOLVE_CREATOR_IDENTITY: "确认达人身份",
        REVIEW_AGENT_FAILURE: "复核 Agent 失败",
        REVIEW_ACTION_PROPOSAL: "审批动作提案",
      ...
      workKinds: {
        RELATIONSHIP: "达人关系",
        APPROVAL_REVIEW: "审批复核",
        CONTENT_FOLLOW_UP: "内容跟进",
        CREATOR_FOLLOW_UP: "达人跟进",
        IDENTITY_RESOLUTION: "身份确认",
        INBOUND_MESSAGE_TRIAGE: "达人消息分流",
        MANUAL_REVIEW: "待人工确认",
      ...
      labels: {
        ...
        nextStep: "下一步",
        relatedProduct: "关联商品",
        whatWillHappen: "同意后会发生什么",
        currentSituation: "当前情况",
      },
      proposalRecommendationTitles: {
        ADD_CREATOR_TAG: "添加标签“{{name}}”",
        REMOVE_CREATOR_TAG: "移除标签“{{name}}”",
        MANAGE_CREATOR_TAG: "应用 {{count}} 项标签变更",
        NO_ACTION_NEEDED: "无需采取行动",
        APPROVE_SAMPLE_REQUEST: "同意这条样品申请",
        REJECT_SAMPLE_REQUEST: "拒绝这条样品申请",
        SEND_MESSAGE: "向达人发送消息",
      },
      proposalExecutionDescriptions: {
        MANAGE_CREATOR_TAG: "系统将对该达人关系应用 {{count}} 项手动标签变更。",
        NO_ACTION_NEEDED:
          "Agent 已完成这次 dispatch，没有请求或执行任何平台动作。",
        APPROVE_SAMPLE_REQUEST: "系统会在 TikTok Shop 中同意该达人的样品申请。",
      ...
      policyActions: {
        MANAGE_CREATOR_TAG: "管理达人标签",
        SEND_MESSAGE: "发送消息",
        REVIEW_SAMPLE_APPLICATION: "审核样品申请",
      },
      policyActionDescriptions: {
        MANAGE_CREATOR_TAG: "在 Agent 变更达人手动标签前需要审批。",
        SEND_MESSAGE: "Agent 向达人发送消息前，需要员工审批。",
        REVIEW_SAMPLE_APPLICATION: "样品申请同意或拒绝前，需要员工审批。",
      },
      policies: {
        manualTagsLabel: "手动标签",
        allManualTags: "适用于全部手动标签。",
        excludedManualTagsLabel: "排除的手动标签",
        noExcludedManualTags: "未排除任何手动标签。",
        sampleTiersLabel: "合作进度",
        sampleTierHint: "精确匹配档位，而非阈值。",
        allSampleTiers: "适用于全部合作进度。",
        excludedSampleTiersLabel: "排除的合作进度",
        noExcludedSampleTiers: "未排除任何合作进度。",
        exclusionHint: "当达人关系包含任一被排除的值时，该策略不再匹配。",
        manualTagSummary: "手动标签：{{value}}",
        excludedManualTagSummary: "排除标签：{{value}}",
        sampleTierSummary: "合作进度：{{value}}",
        excludedSampleTierSummary: "排除合作进度：{{value}}",
        title: "安全策略",
        subtitle: "控制哪些达人联盟平台写操作必须先由商家审批，才能真正执行。",
        shopSelector: "选择策略店铺",
        refresh: "刷新策略",
        noAffiliateShops: "当前没有已启用达人联盟的店铺。",
        currentPolicies: "{{shop}} 的策略",
        recommendedHint:
          "推荐基线：该卖家账号下的消息、样品审核和定向合作都需要审批。",
        recommendedReady: "已启用推荐的卖家账号全局审批策略。",
        applyRecommended: "应用推荐策略",
        empty: "该卖家账号还没有配置全局审批策略。",
        addForAction: "新增",
        noPolicyForAction: "该动作暂未配置策略。",
        approvalRequired: "需要审批",
        autoExecute: "自动执行",
        policyCount: "策略 {{count}}",
        enabledPolicyCount: "已启用 {{count}}",
        globalPolicyCount: "全局 {{count}}",
        currentPolicyList: "当前策略",
        copyPolicySystemId: "复制策略系统 ID",
        createTitle: "创建策略",
        editTitle: "编辑策略",
        editorHint:
          "只有所有已配置的条件维度都命中时，策略才会生效。条件为空表示适用于所有。",
        actionLabel: "动作",
        enabledLabel: "启用",
        enabledHint: "启用后，后端命中的动作会先生成审批提案，而不是直接执行。",
        reasonLabel: "原因",
        reasonPlaceholder: "说明为什么这类动作需要审批。",
        defaultReason: "该达人联盟平台动作执行前需要商家审批。",
        campaignsLabel: "活动",
        productIdsLabel: "商品 ID",
        productIdsPlaceholder: "粘贴商品 ID，可用换行、空格或逗号分隔。",
        allCampaigns: "适用于所有活动。",
        allProducts: "适用于所有商品。",
        appliesToAll: "适用于所有",
        appliesToAllDescription: "该动作下所有达人、活动和商品都会命中。",
        allMatchPreview: "{{action}} 将对所有达人、活动和商品要求审批。",
        filteredMatchPreview:
          "只有所有已配置的过滤维度同时命中时，才会要求审批。",
        filteredMatchDescription:
          "不同维度之间是同时满足；同一维度内任意一个值命中即可。",
        campaignSummary: "活动：{{value}}",
        productSummary: "{{count}} 个商品",
        productIdsCount: "已选择 {{count}} 个商品 ID。",
        selectedCount: "已选择 {{count}} 项。",
        unknownSelectedCount: "{{count}} 项已选内容不在当前加载选项中。",
        unknownSummary: "{{count}} 项不可用",
        moreSummary: "另有 {{count}} 项",
        noSelectableOptions: "暂无可选项。",
        noReason: "未填写原因。",
        savePolicy: "保存策略",
        saveSuccess: "审批策略已保存。",
        enable: "启用",
        disable: "禁用",
        enableSuccess: "审批策略已启用。",
        disableSuccess: "审批策略已禁用。",
        deleteTitle: "删除策略",
        deleteConfirm: "确定删除这条审批策略吗？",
        deleteSuccess: "审批策略已删除。",
        deleteNotFound: "未找到审批策略。",
        recommendedSuccess: "推荐审批策略已启用。",
      },
      predictionComparison: {
        ...
        unknown: "暂无数据",
        forecastAvailable: "已有预测",
        lowExpectedSales: "预测销量偏低",
        modestExpectedSales: "预测销量一般",
        strongExpectedSales: "预测销量较好",
        humanWouldApprove: "通常会同意",
        humanWouldReject: "通常会拒绝",
        humanInsufficient: "历史不足",
        humanApprovalProbability: "历史通过倾向 {{probability}}",
        sameDecision: "一致",
        differentDecision: "不同",
        sameDecisionHint: "AI 建议和历史人工习惯一致。",
        differentDecisionHint:
          "AI 建议和历史人工习惯不同，建议重点核对这条申请。",
        modelDecisions: {
          APPROVE: "同意样品",
          REJECT: "拒绝样品",
        },
      ...
      collaborationWorkTitles: {
        ...
        SAMPLE_AWAITING_SHIPMENT: "寄出已同意的样品",
        SAMPLE_CONTENT_FOLLOW_UP_DUE: "跟进样品内容发布",
        CREATOR_ACTION_FOLLOW_UP_DUE: "跟进达人下一步",
        REVIEW_ACTION_PROPOSAL: "审批 Agent 提案",
        PROPOSAL_REJECTED: "提案已拒绝，等待人工接手",
        PROPOSAL_REVISION_REQUESTED: "已请求 Agent 重写提案",
        PRODUCT_CONTEXT_MISSING: "确认这次合作对应的商品",
        CREATOR_IDENTITY_UNRESOLVED: "确认达人身份",
        STAFF_REVIEW_REQUESTED: "判断下一步如何处理",
        AGENT_RUN_FAILED: "查看 AI 处理失败原因",
        WAITING_CREATOR: "等待达人下一步动作",
        WAITING_PLATFORM: "等待平台状态更新",
        DONE: "这次合作已处理完成",
        BLOCKED: "该达人已被阻止",
        DEFAULT: "查看这条达人合作",
      },
      collaborationWorkDescriptions: {
        ...
        SHIP_SAMPLE:
          "样品申请已经同意，将由 TikTok FBT 自动履约，无需员工安排发货。",
        FOLLOW_UP_CREATOR:
          "达人侧下一步动作已超时，需要根据当前合作上下文跟进达人。",
        REVIEW_ACTION_PROPOSAL:
          "Agent 已经生成平台动作提案，请在工作台同意或拒绝。",
        REVIEW_AGENT_FAILURE:
          "Agent 没有成功完成处理，请查看记录并人工决定下一步。",
        RESOLVE_CREATOR_IDENTITY:
          "系统还不能稳定识别该达人，需要人工确认身份或等待更多平台信息。",
        REVIEW_COLLABORATION:
          "这条合作需要人工判断。可以打开详情查看历史，再决定是否去平台处理。",
        PROPOSAL_REJECTED:
          "员工已拒绝 Agent 的建议。系统不会执行该提案，后续需要人工处理或等待新的达人/平台事件。",
        PROPOSAL_REVISION_REQUESTED:
          "员工已要求 Agent 根据备注重新生成提案。备注会进入下一次 Agent 运行上下文。",
        WAITING_CREATOR:
          "当前不需要员工操作，等待达人回复、寄样状态变化或内容发布。",
        WAITING_PLATFORM:
          "当前不需要员工操作，等待 TikTok Shop 同步新的样品、内容或合作状态。",
        WAITING_FBT_SHIPMENT:
          "样品申请已同意，TikTok FBT 正在自动履约，无需员工安排发货。",
      ...
      sampleWorkStatusDescriptions: {
        ...
        APPROVED_AWAITING_SHIPMENT:
          "样品申请已同意，正在等待 TikTok FBT 自动履约。",
        SHIPPED_IN_TRANSIT: "样品已经发出，正在运输途中。",
        DELIVERED_AWAITING_CONTENT: "达人已收到样品，下一步应发布内容。",
        CONTENT_OBSERVED_REVIEWING: "系统已检测到内容，正在等待进一步确认。",
        FULFILLED: "这次样品合作已完成。",
        FULFILLMENT_FAILED: "这次样品合作未能完成。",
        PLATFORM_STATUS_UNKNOWN:
          "TikTok Shop 没有返回可审核的样品状态，系统不会执行样品审核动作。",
        CANCELLED: "样品申请已取消。",
        EXPIRED: "样品申请已过期。",
        DEFAULT: "样品申请状态有更新。",
      },
      sampleWorkStatusLabels: {
        REQUEST_PENDING_REVIEW: "待审核",
        APPROVED_AWAITING_SHIPMENT: "待寄样",
        SHIPPED_IN_TRANSIT: "运输中",
        DELIVERED_AWAITING_CONTENT: "待发布内容",
        CONTENT_OBSERVED_REVIEWING: "内容待确认",
        FULFILLED: "已完成",
        FULFILLMENT_FAILED: "履约失败",
        PLATFORM_STATUS_UNKNOWN: "平台状态未知",
        CANCELLED: "已取消",
        EXPIRED: "已过期",
      },
      sampleSituationPreview:
        "{{statusDescription}} 已观察到 {{contentCount}} 个内容。",
      manualFollowUpNote:
        "员工已拒绝 Agent 提案。该事项仍需要人工在平台或后续沟通中处理。",
      sampleStatusPreview:
        "样品状态：{{status}}；已观察到 {{contentCount}} 个内容。",
      lifecycleEventPreview: "平台/系统事件：{{eventType}}",
    },
    customerServiceWorkspace: {
      title: "客服管理",
      subtitle:
        "集中查看跨店铺客服会话，控制 AI 接管状态，并处理需要人工判断的升级请求。",
      conversationsPageTitle: "客服对话",
      conversationsPageSubtitle: "查看跨店铺买家会话、AI 接管状态和最近消息。",
      escalationsPageTitle: "客服升级",
      escalationsPageSubtitle: "处理客服 Agent 提交给人工判断的升级请求。",
      allShops: "全部店铺",
      conversationsTab: "客服会话",
      escalationsTab: "升级请求",
      conversationCount: "{{count}} 个会话",
      openCount: "{{count}} 个未完成升级",
      queueHint: "服务端分页，并由 desktop subscription 实时更新。",
      conversationQueueHint: "由平台 webhook 和定期 reconcile 同步共同维护。",
      escalationQueueHint: "需要人工判断后再让 CS Agent 继续处理的事项。",
      llmUnavailableTooltip: "没有可用的 AI 模型密钥。",
      refresh: "刷新",
      conversationEmpty: "当前筛选条件下暂无客服会话。",
      empty: "暂无未完成升级。",
      statusOpen: "未完成",
      statusAll: "全部状态",
      aiAll: "全部 AI 状态",
      aiEnabled: "AI 已开启",
      aiDisabled: "AI 已关闭",
      escalationAll: "全部升级状态",
      escalationOpen: "有未完成升级",
      ...
      badReviewBadge: "差评",
      openBadReviewDetails: "查看差评详情",
      badReviewModalTitle: "商品评价",
      badReviewRating: "{{rating}} 星",
      badReviewStars: "星",
      badReviewCount: "关联差评",
      badReviewWorstRating: "最低评分",
      badReviewLatest: "最近评价",
      badReviewConversation: "会话 ID",
      badReviewPlatformReviewId: "评价 ID",
      badReviewSku: "SKU",
      badReviewProduct: "商品",
      badReviewUntitled: "未填写标题",
      badReviewNoContent: "该评价没有文字内容。",
      badReviewStatusPending: "待跟进",
      badReviewStatusAttached: "已关联会话",
      badReviewStatusFailed: "无法触达",
      badReviewStatusResolved: "已处理",
      badReviewStatusNotRequired: "无需处理",
      badReviewStatusSuppressed: "已忽略",
      escalationUnavailable: "升级详情暂不可用。",
      filterShop: "店铺",
      filterConversationStatus: "会话状态",
      filterAiState: "AI 接管",
      filterEscalationState: "升级状态",
      filterBadReviewState: "评价状态",
      badReviewAll: "全部评价状态",
      hasBadReview: "有差评",
      ...
      enableAi: "开启 AI",
      disableAi: "关闭 AI",
      aiEnabledToast: "已为该会话开启 AI 接管。",
      aiDisabledToast: "已为该会话关闭 AI 接管。",
      startAi: "立即运行 AI",
      startAiSuccess: "已启动客服 Agent 运行。",
      startAiFailed: "启动客服 Agent 失败。",
      endSession: "结束会话",
      ...
      summarize: "总结",
      summaryTitle: "AI 总结",
      summaryCreated: "已生成会话总结。",
      summaryFailed: "生成会话总结失败。",
      summaryMessageCount: "已总结到 {{count}} 条消息。",
      summaryGenerating: "正在总结会话",
      ...
      dismissConversationEscalationsConfirm:
        "确定关闭该会话下 {{count}} 个未完成升级请求吗？",
      details: "详情",
      conversationDetails: "会话详情",
      search: "搜索",
      conversationSearchPlaceholder: "搜索买家、订单、会话、消息……",
      searchPlaceholder: "搜索 ID、订单、买家、会话、原因……",
      pageSize: "每页 {{count}} 条",
      pageSummary:
        "显示 {{start}}-{{end}} / 共 {{total}} 条 | 第 {{page}} / {{pages}} 页",
      page: "第 {{page}} / {{pages}} 页",
      previous: "上一页",
      next: "下一页",
      version: "版本 {{version}}",
      ...
      order: "订单",
      orderContext: "订单信息",
      orderLoadFailed: "无法加载订单信息。",
      orderRetry: "重试",
      orderUnavailable: "该订单当前不可用。",
      unknownStatus: "未知",
      orderedAt: "下单时间",
      shipping: "物流",
      recipientDetails: "收件信息",
      fullName: "收件人姓名",
      address: "地址",
      zip: "邮编",
      phone: "电话",
      ...
      orderItems: "商品（{{count}}）",
      orderItem: "订单商品",
      afterSales: "退货与退款（{{count}}）",
      noAfterSales: "该订单暂无退货或退款申请。",
      afterSaleRequest: "售后申请",
      createdAt: "创建时间",
      updatedAt: "更新时间",
      messages: "消息",
      noMessages: "该会话暂无已加载消息。",
      manualReplyPlaceholder: "直接回复买家……",
      manualReplySend: "发送",
      manualReplySent: "回复已发送。",
      manualReplyFailed: "发送回复失败。",
      noPreview: "暂无消息预览",
      systemMessage: "系统消息",
      imageMessage: "图片",
      videoMessage: "视频",
      ...
      orderIdLabel: "订单 ID",
      packageIdLabel: "包裹 ID",
      trackingIdLabel: "物流单号",
      selectConversation: "选择一个会话后查看消息和 AI 接管状态。",
      reason: "原因",
      context: "上下文",
      decision: "处理决定",
      ...
      dismissEscalationTooltip:
        "关闭升级请求，但不会唤醒 AI Agent，也不会给买家发送消息。",
      dismissEscalationSuccess: "升级请求已关闭。",
      confirmDismissEscalation: "确定关闭这条升级请求吗？",
      previousEscalation: "上一条",
      nextEscalation: "下一条",
      copyFailed: "复制 ID 失败。",
      respondSuccess: "升级处理意见已发送。",
      conversationStatusPending: "待回复",
      conversationStatusReplied: "已回复",
      statusPending: "待处理",
    ...
    shopAdsStatus: {
      ...
      needs_link: "需要确认",
      needs_advertiser: "未连接广告账户",
      hint_connected: "这个店铺已经关联到 TikTok Ads store binding。",
      hint_needs_link:
        "已经连接 TikTok Ads 账户，但这个店铺还需要确认广告覆盖配置。",
      hint_needs_advertiser:
        "请先连接 TikTok Ads 账户，这个店铺才能用于广告报表。",
    },
    shopDrawer: {
      tabs: {
        overview: "概览",
      ...
      aiCS: {
        ...
        unpaidReachoutHint:
          "订单仍未付款时，由 Backend 按计划最多发送三阶段提醒。",
        unpaidReachoutDelay: "延迟分钟数",
        unpaidReachoutDelayHint: "请输入 1 到 2879 之间的整数分钟。",
        unpaidReachoutInvalidDelay:
          "每个延迟必须是 1 到 2879 之间且不重复的整数分钟。",
        ...
        unpaidReachoutAddStage: "新增阶段",
        unpaidReachoutMaxStages: "最多 3 个",
        unpaidReachoutControlGroup: "保留对照组",
        unpaidReachoutControlHint:
          "对照组订单仍计入 eligible，但不会收到消息。",
        unpaidReachoutHoldoutHint: "% 对照组；修改比例会开始新实验。",
        ...
        unpaidNestedTrafficSummary:
          "{{holdout}}% 不触达对照组 · {{treatment}}% 进入配置优化",
        ...
        badReviewReachoutStarsHint:
          "评分小于等于该星级时视为差评。请输入 1 到 3。",
        badReviewReachoutRecentDays: "跟进天数",
        badReviewReachoutRecentDaysHint:
          "只跟进最近 N 天创建的差评。请输入 1 到 90。",
        reviewOptimizationInvalidStars: "差评星级必须是 1 到 3 之间的整数。",
        reviewOptimizationInvalidRecentDays:
          "跟进天数必须是 1 到 90 之间的整数。",
      },
      affiliate: {
        manualTagAddPreview: "为该达人关系添加标签“{{name}}”。",
        manualTagRemovePreview: "从该达人关系移除标签“{{name}}”。",
        serviceStatus: "服务状态",
        ...
        bindDeviceHint:
          "开启后，本设备会唤醒本地 Agent 处理达人回复和达人生命周期事件。",
        ...
        runProfile: "Agent 权限配置",
        runProfileLabel: "运行配置",
        runProfileHint: "选择一个运行配置来控制达人管理可以使用的工具。",
        runProfileNone: "未选择运行配置",
        ...
        modelScopeDiagnosticsLoading: "正在读取模型评估数据。",
        ...
        proposalRevisionRequestSuccess: "已请求重写，Agent 会参考你的备注。",
        proposalApprovedNote: "通过达人管理审批表同意。",
        proposalRejectedNote: "通过达人管理审批表拒绝。",
        proposalRevisionRequestedNote: "通过达人管理审批表请求重写。",
        requestProposalRevision: "请求重写",
        ignoreProposal: "忽略",
        confirmProposalIgnore: "确认忽略",
        proposalIgnoreConfirmTitle: "确认忽略这条工作？",
        proposalIgnoreConfirmHint:
          "不会发送任何消息，达人收不到回复。这些消息将标记为已处理，Agent 不会再为它们提出建议。达人再来新消息时仍会产生新工作。",
        proposalIgnoreSuccess: "已忽略，未发送回复。",
        proposalIgnoredNote: "通过达人管理审批表忽略。",
        sendProposalRevisionRequest: "发送重写请求",
        proposalRevisionNoteLabel: "重写备注",
        proposalRevisionNotePlaceholder:
          "告诉 Agent 要改什么，例如：同意样品，但回复要更简短。",
        proposalRevisionNoteHint:
          "这些备注会传回 Affiliate Agent，用于生成下一版提案。",
        ...
        sampleShipmentPreview:
          "为申请 {{applicationId}} 寄出 {{quantity}} 件样品",
        ...
        proposalTypes: {
          MANAGE_CREATOR_TAG: "管理标签",
          NO_ACTION_NEEDED: "无需行动",
          SEND_MESSAGE: "发送消息",
          REVIEW_SAMPLE_APPLICATION: "审核样品申请",
          APPROVE_SAMPLE: "同意样品",
          REJECT_SAMPLE: "拒绝样品",
    ...
    inventory: {
      pageTitle: "库存管理",
      pageSubtitle: "管理 WMS 账号和库存商品。",
      shopMappings: "店铺仓库映射",
      shopMappingsSubtitle:
        "选择店铺，启用库存管理，并将平台仓库映射到统一 WMS 仓库。",
      selectShop: "店铺",
      enableShopInventory: "库存管理",
      enableShopHint: "为此店铺启用库存管理后，可以同步并映射平台仓库。",
      noShops: "暂无已连接店铺。",
      ...
      confirmDeleteWmsAccount:
        "确定要删除「{{label}}」吗？此账号会被归档，不再展示或用于同步。",
      ...
      providerUserId: "平台用户 ID",
      authorizationMode: "接入方式",
      authorizationModes: {
        AUTHORIZE: "授权 OMS",
        EXISTING: "已有授权凭证",
      },
      authorizationUser: "OMS 账号邮箱",
      authorizationToken: "一次性授权 Token",
      authorizationDomain: "授权域名",
      authorizationDomainPlaceholder: "可选，默认使用接口地址的域名",
      keepCredentialPlaceholder: "留空则保持已保存的值",
      credentialsWriteOnlyHint: "凭证只写入后端，保存后不会再次展示。",
      credentialMissingFields: "请完整填写这些凭证字段：{{fields}}。",
      credentialFields: {
        apiKey: "API Key / Client ID",
        apiSecret: "API Secret",
        apiToken: "API 令牌",
      ...
      apiTokenIssues: {
        invalidJson:
          '不是有效的 JSON。请粘贴凭证对象，例如 {"appKey":"...","appSecret":"..."}。',
      ...
      apiTokenHints: {
        ...
        XLWMS:
          "请粘贴包含 appKey 和 appSecret 的 JSON。密钥只写入后端，不会再次展示。",
      },
      apiTokenEditHint:
      ...
      inventoryGoodsPageSummary:
        "共 {{count}} 个商品 · 第 {{page}} / {{pages}} 页",
      ...
      shopWarehouses: "店铺仓库",
      shopWarehousesHint:
        "将平台店铺仓库映射到后端 canonical warehouse 后，库存工作流才会使用。",
      syncShopWarehouses: "同步店铺仓库",
      noShopWarehouses:
        "后端还没有此店铺的仓库行。请先同步店铺仓库，让后端创建真实 row 后再映射。",

export default {
  ...
  ecommerce: {
    ...
    customerServiceExperiments: {
      ...
      status: { RUNNING: "运行中", STOPPED_MATURING: "等待成熟", FINAL: "已完成" },

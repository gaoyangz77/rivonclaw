  ...
  tools: {
    selector: {
      ...
      name: {
        ...
        ECOM_GET_WAREHOUSES: "获取仓库列表",
        ECOM_GET_GLOBAL_WAREHOUSES: "获取全球仓库",
        ECOM_GET_ORDER: "获取订单",
        ECOM_LIST_ORDERS: "订单列表",
        ECOM_GET_PRODUCT: "获取商品",
        ECOM_SEARCH_PRODUCTS: "搜索商品",
        ECOM_GET_LOGISTICS_TRACKING: "获取物流追踪",
        ECOM_GET_SHIPPING_PROVIDERS: "获取物流服务商",
        ECOM_SEARCH_SESSIONS: "搜索会话",
        // 电商 — 操作
        ECOM_SEND_MESSAGE: "发送消息",
        ...
        ECOM_CS_GET_LOGISTICS_TRACKING: "获取物流",

export default {
  ...
  tutorial: {
    ...
    adsManagement: {
      ...
      welcomeBody: "这个页面用于连接 TikTok Business 授权，并展示哪些已授权给 EasyClaw 的店铺能被 advertiser 可见 store 覆盖。",
      actionsTitle: "连接与刷新",
      actionsBody: "使用连接 TikTok Business 来授权广告账户访问。刷新会更新广告账户、可见 store 和店铺覆盖状态。",
      summaryTitle: "覆盖概览",
      summaryBody: "这些数字会区分已授权 advertiser，以及真正可以在 EasyClaw 中管理的店铺。",
      advertisersTitle: "广告账户",
      advertisersBody: "每一行都是通过 TikTok Business 授权获得的 advertiser，包括角色、token 状态和可见 store 数量。",
      shopCoverageTitle: "可管理店铺覆盖",
      shopCoverageBody: "只有已经授权给 EasyClaw 的店铺才会进入可操作范围。未 onboarding 的 advertiser 可见 store 只作为信息展示。",
    },
    providers: {
  ...
  adsManagement: {
    ...
    emptyAdvertisersBody: "连接 TikTok Business 或 Ads Manager 后，这里会显示可访问的广告账户和它们可见的 store。",
    shopReadinessTitle: "店铺 Ads 状态",
    shopReadinessSubtitle: "查看每个已连接店铺的广告账户覆盖、store 可见性和 GMV Max 就绪状态。",
    shopCoverageTitle: "可管理店铺覆盖",
    shopCoverageSubtitle: "这里显示的是已授权给 EasyClaw、且能匹配到 advertiser 可见 store 的店铺。",
    unonboardedStoreCount: "{{count}} 个 advertiser 可见 store 尚未在 EasyClaw onboarding",
    noShops: "尚未连接店铺。",
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      creatorThreadPrimaryObject: "合作记录",
      ...
      relationshipThreadCollaborationCount: "{{count}} 个合作",
      threadShortLabel: "记录 {{id}}",
      threadActiveCollaborations: "活跃合作",
      threadPendingProposals: "待审批提案",
      threadUnread: "未读",
      threadMoreCollaborations: "另有 {{count}} 个合作",
      ...
      threadActiveWorkTitle: "{{count}} 个活跃合作",
      threadRelationshipConversationTitle: "达人关系对话",
      threadAmbiguousSummary: "这条合作记录有多个可能的商品上下文，请先核对后再执行商品相关动作。",
      threadDefaultSummary: "店铺和达人之间的合作记录；当商品或样品上下文明确后，具体商品合作会显示在这里。",
      openCreatorThreadDetailHint: "打开合作记录详情，查看对话、提案和相关合作。",
    ...
    shopAdsStatus: {
      ...
      hint_needs_link: "已经连接 TikTok Ads 账户，但这个店铺还需要确认 Ads store 可见性。",

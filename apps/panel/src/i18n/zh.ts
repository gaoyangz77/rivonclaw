export default {
  ...
  ecommerce: {
    ...
    customerServiceWorkspace: {
      ...
      clearEscalationsSuccess: "升级请求已 dismiss。",
      confirmClearConversationEscalations: "确定 dismiss 该会话下所有未完成升级请求吗？这不会唤醒 AI Agent。",
      dismissConversationEscalationsSuccess: "升级请求已 dismiss。",
      dismissConversationEscalationsConfirm: "确定 dismiss 该会话下 {{count}} 个未完成升级请求吗？",
      details: "详情",
      ...
      dismissEscalationSuccess: "升级请求已 dismiss。",
      confirmDismissEscalation: "确定 dismiss 这条升级请求吗？",

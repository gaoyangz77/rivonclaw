export default {
  ...
  ecommerce: {
    ...
    customerServiceExperiments: {
      ...
      actions: { NO_REACHOUT: "不触达", CONTINUE: "正常触达", APPLY_CONFIG: "应用配置" },
      metrics: {
    ...
    affiliateWorkspace: {
      workbench: {
        ...
        tabs: { pendingAgent: "待人工审核", allAgent: "全部 Agent 工作", samples: "待处理申样", messages: "待处理消息" },
        sampleOpen: "待处理", sampleSoftRejected: "柔性拒绝", noSamples: "目前没有待处理的样品申请。", noSoftRejectedSamples: "目前没有柔性拒绝的样品申请。", noMessages: "目前没有待处理的达人消息。", expiresAt: "{{value}} 到期", pendingSince: "自 {{value}} 起待处理", protected: "受保护", humanOnly: "仅人工", agentProposal: "Agent 提案", viewFullBundle: "查看完整 Agent Bundle", sampleSyncIssue: "同步异常", reopen: "重新打开", approveSample: "同意", platformReject: "平台拒绝", softReject: "柔性拒绝", sampleSyncUnknown: "平台状态同步异常，暂时不能审核。", sampleReviewSaved: "申样处理已保存。", rejectReason: "拒绝原因", rejectExplanation: "请说明原因", reviewTitles: { APPROVE: "同意样品申请", PLATFORM_REJECT: "在 TikTok 拒绝", SOFT_REJECT: "柔性拒绝", REOPEN: "重新打开样品申请" }, reviewDescriptions: { APPROVE: "实时校验后将在 TikTok 同意该申请。", PLATFORM_REJECT: "实时校验后将在 TikTok 拒绝该申请。", SOFT_REJECT: "只记录商家拒绝决定，不调用 TikTok，让申请自然过期。", REOPEN: "若 TikTok 仍允许审核，则重新打开本地决定。" },
      },
      rejectReasons: { CREATOR_BLACKLISTED: "达人已屏蔽", DUPLICATE_APPLICATION: "重复申请", LOW_EXPECTED_SALES: "预期销量低", NOT_MATCH: "不匹配", OFFLINE: "已下线", OTHER: "其他", OUT_OF_STOCK: "缺货", PLATFORM_ERROR: "平台错误" },
      title: "达人管理",
      subtitle: "集中审核 Agent 为达人生命周期生成的待执行动作。",
      creatorsTitle: "合作达人",
      creatorsSubtitle: "查看所有已启用 Affiliate 店铺的达人关系，维护标签并处理当前事项。",
      creatorsPanelTitle: "店铺关系池",
      creatorsPanelHint: "默认显示所有已启用 Affiliate 店铺中的达人关系；可按单店缩小范围。",

export default {
  ...
  adsManagement: {
    ...
    connectShopAds: "授权店铺 Ads",
    totalAdvertisers: "广告账户数",
    authorizedAdvertisers: "已授权",
    adsReadyShops: "广告就绪店铺",
    totalBusinessConnections: "Business 连接数",
    authorizedBusinessConnections: "已授权",
    managedShops: "可管理店铺",
    authSeparationHint: "TikTok Ads 能力通过 Business/Ads Manager 授权。EasyClaw 只管理同时已授权为 TikTok Shop 的店铺。",
    businessAccountHint: "Advertiser 是 TikTok Ads API 的执行范围。只有当 advertiser 可见的 store 能匹配到 EasyClaw 已授权店铺时，才会进入可管理范围。",
    businessTableTitle: "Business 连接",
    businessTableSubtitle: "每个连接代表一次 TikTok Business 授权，其下的广告账户提供 campaign 和报表访问能力。",
    emptyBusinessTitle: "尚未连接 TikTok Business",
    emptyBusinessBody: "请连接用户的 TikTok Business 或 Ads Manager 账号，然后查看哪些已授权店铺被其广告账户覆盖。",
    defaultBusinessName: "TikTok Business 连接",
    advertiserTableTitle: "广告账户",
    advertiserTableSubtitle: "这些账户会被 Airflow 用来同步 campaign、ad group、ad 以及 GMV Max 报表数据。",
    emptyAdvertisersTitle: "尚未连接广告账户",
    emptyAdvertisersBody: "TikTok Business 授权成功后，广告账户会显示在这里。",
    ...
    unmatchedStoreCount: "{{count}} 个 advertiser 可见 store 未匹配",
    noShops: "尚未连接店铺。",
    ...
    shopOAuthModalTitle: "授权 TikTok 店铺",
    openShopAuthLink: "打开 TikTok Shop 授权链接",
    shopOAuthHint: "请在已登录该店铺 Seller Center 账号的浏览器中打开此链接。",
    waitingShopAuth: "正在等待 TikTok Shop 授权...",
    shopOAuthSuccess: "TikTok Shop 店铺授权完成。",
    shopOAuthFailed: "启动 TikTok Shop 授权失败。",
    shopOAuthTimeout: "店铺授权超时。如果已经在浏览器中完成授权，请刷新此页面。",
    copyFailed: "复制授权链接失败。",
    disconnect: "断开连接",
  ...
  ecommerce: {
    ...
    shopDrawer: {
      ...
      affiliate: {
        ...
        minP50SalesUnits: "最低 P50 销量",
        minP50SalesUnitsHint: "当合作没有更具体的 Campaign 阈值时，Agent 会把这个数作为默认放量/寄样判断参考。留空表示不配置默认数值。",
        noThreshold: "未设置",
        invalidDecisionThreshold: "最低 P50 销量必须是 0 或更大的整数。",

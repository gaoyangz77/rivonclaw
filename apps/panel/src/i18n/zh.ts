export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      intelligenceClaimPrecisionTitle: "同样样品预算，预计销量更高",
      intelligenceClaimPrecisionBody: "如果同样放出 {{count}} 个样品，模型选择的达人预计比历史人工选择多卖 {{lift}}。",
      intelligenceClaimPrecisionNeutral: "如果同样放出 {{count}} 个样品，本次模型暂时还没有显示出明确提升。",
      intelligenceClaimReachTitle: "同样销量门槛下覆盖更多合格达人",
      intelligenceClaimReachBody: "在预期销量 {{bar}} 件的门槛下，模型找到 {{creators}} 个合格达人，其中 {{overlooked}} 个是历史人工未通过的达人。",
      intelligenceClaimReachNeutral: "在同样预期销量门槛下，本次模型暂时还没有显示出更广的合格达人覆盖。",
      intelligenceChartSameBudget: "同样发样数量",
      intelligenceChartSameSalesBar: "相同预期销量门槛",
      intelligenceChartCreatorSwap: "模型会替换哪些选择",
      intelligenceSameBudgetStory: "{{window}} · 对比同样 {{count}} 个发样机会下的预期销量",
      intelligenceSameSalesBarStory: "{{window}} · 高于同一个 {{bar}} 件预期销量门槛的达人",
      ...
      intelligenceModelQualifiedCreators: "模型判定合格达人",
      ...
      intelligenceBudgetStatsTitle: "为什么模型更会挑人",
      intelligenceBudgetStatsHeadline: "同样发样数量，模型选择的人更偏向高销量区间",
      intelligenceBudgetStatsHint: "{{window}} · 只比较相同发样数量下的预期销量分布。",
      intelligenceHistoricalExpectedUnits: "人工预期销量",
      intelligenceModelExpectedUnits: "模型预期销量",
      intelligenceHistoricalApprovedExpected: "历史人工选择 · 预期销量",
      intelligenceReachStatsTitle: "模型还能发现谁",
      intelligenceReachStatsHeadline: "销量门槛相同，发现更多合格达人",
      intelligenceReachStatsHint: "{{window}} · 预期销量达到或超过 {{bar}} 件的达人。",
      intelligenceOverlookedQualifiedCreators: "被人工漏掉的合格达人",

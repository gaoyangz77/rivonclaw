export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      sampleTierColumnLabel: "当前进度",
      sampleTierColumnHint: "所有店铺中达到的最高档位",
      ...
      policies: {
        ...
        sampleTiersLabel: "当前进度",
        sampleTierHint: "精确匹配档位，而非阈值。",
        allSampleTiers: "适用于全部进度。",
        excludedSampleTiersLabel: "排除的进度",
        noExcludedSampleTiers: "未排除任何进度。",
        exclusionHint: "当达人关系包含任一被排除的值时，该策略不再匹配。",
        manualTagSummary: "手动标签：{{value}}",
        excludedManualTagSummary: "排除标签：{{value}}",
        sampleTierSummary: "当前进度：{{value}}",
        excludedSampleTierSummary: "排除进度：{{value}}",
        title: "安全策略",

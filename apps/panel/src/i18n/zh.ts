export default {
  ...
  ecommerce: {
    ...
    affiliateWorkspace: {
      ...
      creatorTagFilter: "标签筛选",
      allCreatorTagsFilter: "全部标签",
      creatorAttentionOnly: "仅看需处理",
      creatorSearchPlaceholder: "搜索昵称、账号或达人 ID",
      creatorTagsEmpty: "暂无标签",
      creatorTagAdd: "添加标签",
      creatorTagRemove: "移除标签",
      creatorTagApplySuccess: "达人标签已更新",
      creatorTagUpdateFailed: "更新达人标签失败",
      ...
      creatorSystemTags: {
        VIP: "VIP",
        HIGH_GMV: "高 GMV",
        GOOD_FULFILLMENT: "履约良好",
        SAMPLE_RISK: "样品风险",
        NO_SAMPLE_AGAIN: "不再寄样",
        DORMANT: "沉睡达人",
        BLOCKED: "已屏蔽",
      },

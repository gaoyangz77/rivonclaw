  ...
  de: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        scopeTitle: "Vier Workbench-Ansichten",
        scopeBody: "Wechseln Sie zwischen ausstehender Agent-Prüfung, aller Agent-Arbeit, Probeanträgen und Creator-Nachrichten. Die beiden Entitätsansichten decken alle autorisierten Shops ab; ein Klick auf eine Zeile öffnet die Creator-Details zur Bearbeitung.",
  ...
  es: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        scopeTitle: "Cuatro vistas del banco de trabajo",
        scopeBody: "Cambia entre el trabajo del Agent pendiente de revisión, todo el trabajo del Agent, las solicitudes de muestra y los mensajes de creadores. Las dos vistas de entidades cubren todas las tiendas autorizadas; haz clic en una fila para abrir el detalle del creador.",
  ...
  fr: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        scopeTitle: "Quatre vues de l'atelier",
        scopeBody: "Basculez entre le travail de l'Agent en attente de validation, tout le travail de l'Agent, les demandes d'échantillons et les messages des créateurs. Les deux vues d'entités couvrent toutes les boutiques autorisées ; cliquez sur une ligne pour ouvrir le détail du créateur.",
  ...
  id: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        scopeTitle: "Empat tampilan workbench",
        scopeBody: "Beralih antara pekerjaan Agent yang menunggu tinjauan, semua pekerjaan Agent, permohonan sampel, dan pesan kreator. Kedua tampilan entitas mencakup semua toko yang terotorisasi; klik satu baris untuk membuka detail kreator.",
  ...
  it: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        scopeTitle: "Quattro viste del workbench",
        scopeBody: "Passa tra il lavoro dell'Agent in attesa di revisione, tutto il lavoro dell'Agent, le richieste di campioni e i messaggi dei creator. Le due viste per entità coprono tutti i negozi autorizzati; fai clic su una riga per aprire il dettaglio del creator.",
  ...
  th: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        scopeTitle: "สี่มุมมองของเวิร์กเบนช์",
        scopeBody: "สลับระหว่างงาน Agent ที่รอตรวจสอบ งาน Agent ทั้งหมด คำขอตัวอย่างสินค้า และข้อความครีเอเตอร์ มุมมองเอนทิตีทั้งสองครอบคลุมทุกร้านที่ได้รับอนุญาต คลิกที่แถวเพื่อเปิดรายละเอียดครีเอเตอร์",

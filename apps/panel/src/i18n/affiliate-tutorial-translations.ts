  ...
  de: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        detailContextTitle: "Entscheidungsgrundlage",
        detailContextBody: "Der Kontextbereich zeigt Auslöser, Beziehungsdaten, den jüngsten Verlauf und frühere Agent-Arbeit zum Zeitpunkt des Vorschlags. Prüfen Sie hier, warum die Aufgabe entstanden ist.",
        detailDecisionTitle: "Empfehlung und Entscheidung",
        detailDecisionBody: "Prüfen Sie Empfehlung, Samples oder Produkt, Nachrichtenentwurf, Prognosevergleich und Revisionen. Eine Genehmigung kann die Arbeit ausführen; fordern Sie bei unzureichenden Belegen eine Überarbeitung an.",
      },
  ...
  es: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        detailContextTitle: "Pruebas para la decisión",
        detailContextBody: "El panel de contexto conserva el origen, los datos de la relación, la cronología reciente y el trabajo anterior del Agente en el momento de la propuesta. Úsalo para validar por qué existe el trabajo.",
        detailDecisionTitle: "Recomendación y decisión",
        detailDecisionBody: "Revisa la recomendación, muestras o producto, borrador del mensaje, comparación predictiva y revisiones. Aprobar puede ejecutar el trabajo; solicita una revisión si las pruebas no bastan.",
      },
      ecommerceAffiliateCreators: {
  ...
  fr: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        detailContextTitle: "Éléments de décision",
        detailContextBody: "Le volet de contexte fige le déclencheur, les faits de la relation, la chronologie récente et les travaux précédents de l’Agent au moment de la proposition. Vérifiez-y la raison du travail.",
        detailDecisionTitle: "Recommandation et décision",
        detailDecisionBody: "Examinez la recommandation, les échantillons ou le produit, le brouillon du message, la comparaison prédictive et les révisions. Une approbation peut exécuter le travail ; demandez une révision si nécessaire.",
      },
      ecommerceAffiliateCreators: {
  ...
  id: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        detailContextTitle: "Bukti keputusan",
        detailContextBody: "Panel konteks menyimpan pemicu, fakta hubungan, linimasa terbaru, dan pekerjaan Agent sebelumnya pada saat proposal dibuat. Gunakan untuk memastikan alasan pekerjaan ini muncul.",
        detailDecisionTitle: "Rekomendasi dan keputusan",
        detailDecisionBody: "Tinjau rekomendasi, sampel atau produk, draf pesan, perbandingan prediksi, dan revisi. Persetujuan dapat menjalankan pekerjaan; minta revisi bila bukti belum memadai.",
      },
      ecommerceAffiliateCreators: {
  ...
  it: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        detailContextTitle: "Prove per la decisione",
        detailContextBody: "Il pannello di contesto conserva origine, dati della relazione, cronologia recente e precedenti lavori dell’Agent al momento della proposta. Usalo per verificare perché il lavoro esiste.",
        detailDecisionTitle: "Raccomandazione e decisione",
        detailDecisionBody: "Esamina raccomandazione, campioni o prodotto, bozza del messaggio, confronto predittivo e revisioni. L’approvazione può eseguire il lavoro; richiedi una revisione se le prove non bastano.",
      },
      ecommerceAffiliateCreators: {
        welcomeTitle: "Creator",
  ...
  th: {
    tutorial: {
      ecommerceAffiliateAttention: {
        ...
        detailContextTitle: "หลักฐานสำหรับการตัดสินใจ",
        detailContextBody: "แผงบริบทเก็บเหตุเริ่มต้น ข้อมูลความสัมพันธ์ ไทม์ไลน์ล่าสุด และงานก่อนหน้าของ Agent ณ เวลาที่สร้างข้อเสนอ ใช้เพื่อตรวจสอบว่าเหตุใดงานนี้จึงเกิดขึ้น",
        detailDecisionTitle: "คำแนะนำและการตัดสินใจ",
        detailDecisionBody: "ตรวจสอบคำแนะนำ ตัวอย่างหรือสินค้า ร่างข้อความ การเปรียบเทียบการคาดการณ์ และการแก้ไข การอนุมัติอาจดำเนินงานจริง โปรดขอแก้ไขหากหลักฐานยังไม่เพียงพอ",
      },
      ecommerceAffiliateCreators: {

...
const copy = {
  en: {
    ...
    actionInvalid: "Choose PROTECT or UNPROTECT from the list, or leave the cell blank to remove protection.",
    tagInvalid: "Choose an existing manual tag from the list. Tags that do not exist are rejected. Create new tags in the system first, then download the template again.",
    noTags: "No manual tags exist yet, so this column must stay blank. Create tags in the system first, then download the template again.",
    unknownTags: "Unknown manual tags: {{names}}. Create them in the system first, or choose an existing tag.",
  ...
  zh: {
    ...
    tagInvalid: "请从列表中选择已有的人工标签。不存在的标签会被拒绝；请先在系统中创建新标签，再重新下载模板。",
  ...
  de: {
    ...
    actionInvalid: "Wählen Sie PROTECT oder UNPROTECT aus der Liste oder lassen Sie die Zelle leer, um den Schutz zu entfernen.",
    tagInvalid: "Wählen Sie einen vorhandenen manuellen Tag aus der Liste. Nicht vorhandene Tags werden abgelehnt. Legen Sie neue Tags zuerst im System an und laden Sie die Vorlage erneut herunter.",
    noTags: "Es gibt noch keine manuellen Tags, daher muss diese Spalte leer bleiben. Legen Sie Tags zuerst im System an und laden Sie die Vorlage erneut herunter.",
    unknownTags: "Unbekannte manuelle Tags: {{names}}. Legen Sie sie zuerst im System an oder wählen Sie einen vorhandenen Tag.",
  ...
  es: {
    ...
    actionInvalid: "Elige PROTECT o UNPROTECT de la lista, o deja la celda vacía para quitar la protección.",
    tagInvalid: "Elige una etiqueta manual existente de la lista. Las etiquetas que no existen se rechazan. Crea primero las nuevas en el sistema y vuelve a descargar la plantilla.",
    noTags: "Aún no hay etiquetas manuales, así que esta columna debe quedar vacía. Crea primero las etiquetas en el sistema y vuelve a descargar la plantilla.",
    unknownTags: "Etiquetas manuales desconocidas: {{names}}. Créalas primero en el sistema o elige una etiqueta existente.",
  ...
  fr: {
    ...
    actionInvalid: "Choisissez PROTECT ou UNPROTECT dans la liste, ou laissez la cellule vide pour retirer la protection.",
    tagInvalid: "Choisissez un tag manuel existant dans la liste. Les tags inexistants sont refusés. Créez d’abord les nouveaux tags dans le système, puis retéléchargez le modèle.",
    noTags: "Aucun tag manuel n’existe encore : cette colonne doit rester vide. Créez d’abord des tags dans le système, puis retéléchargez le modèle.",
    unknownTags: "Tags manuels inconnus : {{names}}. Créez-les d’abord dans le système ou choisissez un tag existant.",
  ...
  id: {
    ...
    actionInvalid: "Pilih PROTECT atau UNPROTECT dari daftar, atau kosongkan sel untuk menghapus perlindungan.",
    tagInvalid: "Pilih tag manual yang sudah ada dari daftar. Tag yang belum ada akan ditolak. Buat tag baru di sistem terlebih dahulu, lalu unduh ulang template.",
    noTags: "Belum ada tag manual, jadi kolom ini harus dikosongkan. Buat tag di sistem terlebih dahulu, lalu unduh ulang template.",
    unknownTags: "Tag manual tidak dikenal: {{names}}. Buat dulu di sistem, atau pilih tag yang sudah ada.",
  ...
  it: {
    ...
    actionInvalid: "Scegli PROTECT o UNPROTECT dall’elenco, oppure lascia la cella vuota per rimuovere la protezione.",
    tagInvalid: "Scegli un tag manuale esistente dall’elenco. I tag inesistenti vengono rifiutati. Crea prima i nuovi tag nel sistema, poi scarica di nuovo il modello.",
    noTags: "Non esistono ancora tag manuali, quindi questa colonna deve restare vuota. Crea prima i tag nel sistema, poi scarica di nuovo il modello.",
    unknownTags: "Tag manuali sconosciuti: {{names}}. Creali prima nel sistema oppure scegli un tag esistente.",
  ...
  th: {
    ...
    tagInvalid: "เลือกแท็กที่กำหนดเองที่มีอยู่จากรายการ แท็กที่ไม่มีอยู่จะถูกปฏิเสธ ให้สร้างแท็กใหม่ในระบบก่อน แล้วดาวน์โหลดเทมเพลตใหม่",

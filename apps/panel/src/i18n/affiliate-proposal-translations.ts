    ...
    ecommerce: { affiliateWorkspace: {
      ...
      agentWorkTable: {
        ...
        creatorMetrics: {
          ...
          activeSamples: "Muestras activas",
        },
        type: "Tipo",
    ...
    ecommerce: { affiliateWorkspace: {
      ...
      agentWorkTable: {
        ...
        creatorMetrics: {
          ...
          gmv: "GMV commercial",
          avgViews: "Vues moy.",
          activeSamples: "Échantillons actifs",
        },
        type: "Type",
    ...
    ecommerce: { affiliateWorkspace: {
      ...
      agentWorkTable: {
        ...
        creatorMetrics: {
          ...
          activeSamples: "ตัวอย่างที่กำลังดำเนินการ",
        },
        type: "ประเภท",
        work: "งาน Agent",
        status: "สถานะ",

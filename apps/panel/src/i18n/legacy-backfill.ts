  ...
  "de": {
    ...
    "ecommerce": {
      "affiliateWorkspace": {
        ...
        "messageComposerPartsHint": "1–10 geordnete Text-/Dateiteile; kein kanalübergreifendes Fallback",
        ...
        "relationshipWorkNoCollaborations": "Diesem Creator sind noch keine Plattformkooperationen zugeordnet.",
        ...
        "relationshipWorkAmbiguousSummary": "Diese Aufgabe hat mehrere mögliche Plattformkooperationskontexte. Prüfen Sie sie vor produktspezifischen Aktionen.",
        "openCreatorRelationshipWorkDetailHint": "Creator-Arbeitsbereich öffnen, um Aufgaben, Samples, Plattformkooperationen, Kommunikation und Aktivitäten zu prüfen.",
  ...
  "es": {
    ...
    "ecommerce": {
      "affiliateWorkspace": {
        ...
        "messageComposerPartsHint": "1–10 partes ordenadas de texto/archivo; sin cambio entre canales",
        ...
        "relationshipWorkNoCollaborations": "Todavía no hay colaboraciones de plataforma asociadas a este creador.",
        ...
        "relationshipWorkAmbiguousSummary": "Este trabajo tiene varios contextos posibles de colaboración de plataforma. Revísalos antes de ejecutar acciones específicas de producto.",
        "openCreatorRelationshipWorkDetailHint": "Abre el espacio del creador para revisar tareas, muestras, colaboraciones de plataforma, comunicación y actividad.",
  ...
  "fr": {
    ...
    "ecommerce": {
      "affiliateWorkspace": {
        ...
        "messageComposerPartsHint": "1 à 10 parties texte/fichier ordonnées ; aucun repli entre canaux",
        ...
        "relationshipWorkNoCollaborations": "Aucune collaboration plateforme n’est encore associée à ce créateur.",
        ...
        "relationshipWorkAmbiguousSummary": "Ce travail possède plusieurs contextes possibles de collaboration plateforme. Vérifiez-les avant toute action liée à un produit.",
        "openCreatorRelationshipWorkDetailHint": "Ouvrez l'espace du créateur pour examiner les tâches, échantillons, collaborations plateforme, échanges et activités.",
  ...
  "id": {
    ...
    "ecommerce": {
      "affiliateWorkspace": {
        ...
        "relationshipWorkNoCollaborations": "Belum ada kolaborasi platform yang terkait dengan kreator ini.",
        ...
        "relationshipWorkAmbiguousSummary": "Pekerjaan ini memiliki beberapa kemungkinan konteks kolaborasi platform. Tinjau sebelum melakukan tindakan khusus produk.",
        "openCreatorRelationshipWorkDetailHint": "Buka ruang kerja kreator untuk meninjau pekerjaan, sampel, kolaborasi platform, komunikasi, dan aktivitas.",
  ...
  "it": {
    ...
    "ecommerce": {
      "affiliateWorkspace": {
        ...
        "openCreatorRelationshipWorkDetailHint": "Apri lo spazio di lavoro del creator per rivedere attività, campioni, collaborazioni della piattaforma, comunicazioni e cronologia.",
        "messageChannels": {
          "PLATFORM_CHAT": "TikTok Shop",
          "WHATSAPP": "WhatsApp",
          "EMAIL": "Email"
        ...
        "relationshipWorkAmbiguousSummary": "Questo lavoro ha più contesti possibili di collaborazione della piattaforma. Verificali prima di eseguire azioni specifiche sul prodotto.",
        ...
        "relationshipWorkNoCollaborations": "Nessuna collaborazione della piattaforma è ancora associata a questo creator.",
  ...
  "th": {
    ...
    "ecommerce": {
      "affiliateWorkspace": {
        ...
        "openCreatorRelationshipWorkDetailHint": "เปิดพื้นที่ทำงานของครีเอเตอร์เพื่อตรวจสอบงาน ตัวอย่าง ความร่วมมือบนแพลตฟอร์ม การสื่อสาร และกิจกรรม",
        "messageChannels": {
          "PLATFORM_CHAT": "TikTok Shop",
          "WHATSAPP": "WhatsApp",
          "EMAIL": "Email"
        ...
        "relationshipWorkAmbiguousSummary": "งานนี้มีบริบทความร่วมมือบนแพลตฟอร์มที่เป็นไปได้หลายรายการ โปรดตรวจสอบก่อนดำเนินการเฉพาะสินค้า",

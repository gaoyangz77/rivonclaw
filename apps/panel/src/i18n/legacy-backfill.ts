...
export const LEGACY_I18N_BACKFILL = {
  "de": {
    "adsManagement": {
      ...
      "shopCoverageSubtitle": "Hierbei handelt es sich um von EasyClaw autorisierte Shops, die mit für Werbetreibende sichtbaren Shops verknüpft werden können.",
  ...
  "es": {
    "adsManagement": {
      ...
      "shopCoverageSubtitle": "Estas son tiendas autorizadas por EasyClaw que pueden relacionarse con tiendas visibles para los anunciantes.",
  ...
  "fr": {
    "adsManagement": {
      ...
      "shopCoverageSubtitle": "Il s'agit de magasins autorisés par EasyClaw qui peuvent être associés à des magasins visibles par les annonceurs.",
  ...
  "id": {
    "adsManagement": {
      ...
      "shopCoverageSubtitle": "Ini adalah toko resmi EasyClaw yang dapat dicocokkan dengan toko yang terlihat oleh pengiklan.",
  ...
  "it": {
    "adsManagement": {
      ...
      "shopCoverageSubtitle": "Si tratta di negozi autorizzati EasyClaw che possono essere abbinati ai negozi visibili agli inserzionisti.",
  ...
  "th": {
    "adsManagement": {
      ...
      "shopColumns": {
        ...
        "gmvMax": "จีเอ็มวี แม็กซ์",
        "region": "ภูมิภาค",
        "shop": "ร้านค้า",
        "storeId": "รหัสร้านค้า"
      },
      "shopCoverageSubtitle": "ร้านค้าเหล่านี้เป็นร้านค้าที่ได้รับอนุญาตจาก EasyClaw ซึ่งสามารถจับคู่กับร้านค้าที่ผู้ลงโฆษณามองเห็นได้",

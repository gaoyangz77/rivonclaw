...
export const LANGUAGE_OPTIONS: readonly LanguageOption[] = [
  ...
  { code: "es", label: "Español", resource: mergeTranslationResources(es, LEGACY_I18N_BACKFILL.es, RECENT_TRANSLATIONS.es, CUSTOMER_SERVICE_DEVICE_TRANSLATIONS.es, GOOGLE_AUTH_TRANSLATIONS.es, BROWSER_AUTH_TRANSLATIONS.es, AFFILIATE_TIMELINE_TRANSLATIONS.es, AFFILIATE_TEAM_TRANSLATIONS.es, AFFILIATE_CHANNEL_TRANSLATIONS.es, AFFILIATE_PROJECTION_TRANSLATIONS.es, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.es, AFFILIATE_CAMPAIGN_TRANSLATIONS.es, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.es, AFFILIATE_PROPOSAL_TRANSLATIONS.es, AFFILIATE_NO_ACTION_GATE_TRANSLATIONS.es, AFFILIATE_DELIVERED_MESSAGE_TRANSLATIONS.es, AFFILIATE_COLLABORATION_OPERATION_TRANSLATIONS.es, PRODUCT_KNOWLEDGE_TRANSLATIONS.es, AFFILIATE_ANALYTICS_TRANSLATIONS.es, SUB_ACCOUNT_TRANSLATIONS.es, TUTORIAL_NEW_KEYS_EN, AFFILIATE_TUTORIAL_TRANSLATIONS.es) },

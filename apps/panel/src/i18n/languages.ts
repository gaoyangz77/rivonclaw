...
export const LANGUAGE_OPTIONS: readonly LanguageOption[] = [
  { code: "en", label: "English", resource: mergeTranslationResources(en, AFFILIATE_TEAM_TRANSLATIONS.en, AFFILIATE_CHANNEL_TRANSLATIONS.en, AFFILIATE_PROJECTION_TRANSLATIONS.en, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.en, AFFILIATE_CAMPAIGN_TRANSLATIONS.en, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.en) },
  { code: "zh", label: "中文", resource: mergeTranslationResources(zh, AFFILIATE_TEAM_TRANSLATIONS.zh, AFFILIATE_CHANNEL_TRANSLATIONS.zh, AFFILIATE_PROJECTION_TRANSLATIONS.zh, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.zh, AFFILIATE_CAMPAIGN_TRANSLATIONS.zh, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.zh) },
  { code: "de", label: "Deutsch", resource: mergeTranslationResources(de, LEGACY_I18N_BACKFILL.de, RECENT_TRANSLATIONS.de, AFFILIATE_TIMELINE_TRANSLATIONS.de, AFFILIATE_TEAM_TRANSLATIONS.de, AFFILIATE_CHANNEL_TRANSLATIONS.de, AFFILIATE_PROJECTION_TRANSLATIONS.de, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.de, AFFILIATE_CAMPAIGN_TRANSLATIONS.de, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.de) },
  ...
  { code: "fr", label: "Français", resource: mergeTranslationResources(fr, LEGACY_I18N_BACKFILL.fr, RECENT_TRANSLATIONS.fr, AFFILIATE_TIMELINE_TRANSLATIONS.fr, AFFILIATE_TEAM_TRANSLATIONS.fr, AFFILIATE_CHANNEL_TRANSLATIONS.fr, AFFILIATE_PROJECTION_TRANSLATIONS.fr, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.fr, AFFILIATE_CAMPAIGN_TRANSLATIONS.fr, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.fr) },
  { code: "id", label: "Bahasa Indonesia", resource: mergeTranslationResources(id, LEGACY_I18N_BACKFILL.id, RECENT_TRANSLATIONS.id, AFFILIATE_TIMELINE_TRANSLATIONS.id, AFFILIATE_TEAM_TRANSLATIONS.id, AFFILIATE_CHANNEL_TRANSLATIONS.id, AFFILIATE_PROJECTION_TRANSLATIONS.id, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.id, AFFILIATE_CAMPAIGN_TRANSLATIONS.id, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.id) },
  { code: "it", label: "Italiano", resource: mergeTranslationResources(it, LEGACY_I18N_BACKFILL.it, RECENT_TRANSLATIONS.it, AFFILIATE_TIMELINE_TRANSLATIONS.it, AFFILIATE_TEAM_TRANSLATIONS.it, AFFILIATE_CHANNEL_TRANSLATIONS.it, AFFILIATE_PROJECTION_TRANSLATIONS.it, AFFILIATE_CREATOR_PROFILE_TRANSLATIONS.it, AFFILIATE_CAMPAIGN_TRANSLATIONS.it, AFFILIATE_EXPECTED_SALES_TRANSLATIONS.it) },

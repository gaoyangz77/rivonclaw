...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/commerce/affiliate/manual-workbench", pageKey: "ecommerce-affiliate-manual-workbench", component: AffiliateManualWorkbenchPage, icon: <ShopIcon />, navLabelKey: "nav.affiliateManualWorkbench", authRequired: true, parentPath: "/commerce/affiliate", scope: GQL.PermissionScope.Affiliate },
  ...
  { path: "/account/usage", pageKey: "usage", component: KeyUsagePage, icon: <UsageIcon />, navLabelKey: "nav.usage" },
  { path: "/account/billing", pageKey: "billing", component: BillingPage, icon: <BillingIcon />, navLabelKey: "nav.billing", authRequired: true, navAuthOnly: true, scope: GQL.PermissionScope.Billing },
  { path: "/account/settings", pageKey: "settings", component: SettingsPage, icon: <SettingsIcon />, navLabelKey: "nav.settings" },
  { path: "/account/profile", pageKey: "account", component: AccountPage, icon: <AccountIcon />, navLabelKey: "nav.account", authRequired: true },

...
export const MobileBindingModal = observer(function MobileBindingModal({
  isOpen,
  onClose,
  onBindingSuccess,
}: MobileBindingModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t("mobile.pairTitle")} maxWidth={420}>
              ...
              <>
                ...
                {qrDataUrl && (
                  ...
                  >
                    ...
                    {showBlur && (
                      <div className="qr-privacy-overlay">{t("settings.app.clickToReveal")}</div>
                    )}
                    {expired && !showBlur && (
                ...
                {!expired && !showBlur && (
                  <p className="mobile-countdown">
                    {t("mobile.expiresIn", { seconds: remainingSeconds })}
                  </p>
                )}
              </>
            )}

 ...
 */
export const MobileManagerModel = types.model("MobileManager", {}).actions((_self) => {
  ...
  return {
    ...
    getDeviceStatus: flow(function* () {
      return (yield fetchJson(
        clientPath(API["mobile.deviceStatus"]),
      )) as MobileDeviceStatusResponse;
    }),

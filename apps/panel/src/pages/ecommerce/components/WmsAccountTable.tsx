...
export const WmsAccountTable = observer(function WmsAccountTable({
  ...
  return (
    <TkPanel padding="none" className="ecommerce-inventory-section" data-tutorial-id="shops-wms">
      <TkPanelHeader
        title={t("ecommerce.inventory.wmsAccounts")}
        description={t("ecommerce.inventory.wmsAccountsSubtitle")}
        actions={
          <div className="tk-v1-page-action-group">
            <button
      ...
      <TkPanelBody className="ecommerce-inventory-body">
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="wms-account-label">
                            <span className="tk-v1-table-record-name">{account.label}</span>
                        ...
                        <td className="text-right">
                          <div className="td-actions shop-table-actions wms-account-actions">
                            <button
                              ...
                              onClick={() =>
                                inventory.syncWmsWarehouses(account.id).catch(() => {})
                              }
                              ...
                              <div className="wms-warehouse-list">
                                ...
                                {accountWarehouses.map((warehouse) => (
                                  <div className="wms-warehouse-row" key={warehouse.id}>
                                    <div className="tk-v1-table-record-name">{warehouse.name}</div>

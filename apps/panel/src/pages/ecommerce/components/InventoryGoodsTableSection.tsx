...
export const InventoryGoodsTableSection = observer(function InventoryGoodsTableSection() {
  ...
  return (
    <>
      <TkPanel
        padding="none"
        className="ecommerce-inventory-section"
        data-tutorial-id="inventory-goods"
      >
        <TkPanelHeader
          title={t("ecommerce.inventory.inventoryGoods")}
          description={t("ecommerce.inventory.inventoryGoodsSubtitle")}
          actions={
            <div
              className="inventory-goods-header-actions"
        ...
        <TkPanelBody className="inventory-goods-body">
          <form
              ...
              >
                <thead>
                  <tr>
                    ...
                    {showColumn("flags") && (
                      <th className="inventory-goods-flags-cell">
                        {t("ecommerce.inventory.flags")}
                      </th>
                    )}

...
export function ShopTable({
  ...
  return (
    <TkPanel padding="none" data-tutorial-id="shops-list">
      <TkPanelHeader
        title={t("ecommerce.shops")}
        description={t("ecommerce.shopsSubtitle")}
        actions={
          <div className="tk-v1-page-action-group" data-tutorial-id="shops-actions">
            <button

...
export function SurfacesSection({
  ...
  return (
    <TkPanel
      ...
      data-tutorial-id="account-surfaces"
    >
      <TkPanelHeader
        title={t("surfaces.surfacesTitle")}
        description={t("surfaces.description")}
        actions={
          <div className="tk-v1-page-action-group" data-tutorial-id="account-surface-actions">
            <button
            ...
            {surfaces.length > 0 && (
              <button className="btn btn-secondary btn-sm" onClick={onOpenPreset}>

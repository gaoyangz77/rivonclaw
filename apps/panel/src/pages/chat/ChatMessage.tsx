      ...
      <div
        ...
        className={
          needsCollapse && collapsed
            ? "chat-bubble-collapsible chat-bubble-collapsed"
      ...
      {needsCollapse && (
        ...
        >
          <span className="chat-bubble-collapse-label">
            {collapsed
              ? t("chat.expandMessage", "Show more")
              : t("chat.collapseMessage", "Show less")}
          </span>
          <svg
            className="chat-bubble-collapse-chevron"
            width="12"
            height="12"
            viewBox="0 0 24 24"
            fill="none"
...
export function ToolArgsDisplay({ args }: { args: Record<string, unknown> }) {
  ...
  return (
    <>
      ...
      >
        <svg
          className="chat-tool-args-chevron"
          width="10"
          height="10"
          viewBox="0 0 24 24"
          fill="none"
      ...
      {expanded && <pre className="chat-tool-args-code">{formatted}</pre>}
    </>
  );
}

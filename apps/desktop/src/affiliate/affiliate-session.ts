...
export class AffiliateSession {
  ...
  private buildExtraSystemPrompt(
    ...
    return [
      ...
      "- Before proposing a system-tag change, call affiliate_list_system_tags and use a returned enum. NO_CAMPAIGN_DISTURB blocks only future mechanical Campaign outreach; it never blocks a normal Affiliate workflow or a direct reply.",

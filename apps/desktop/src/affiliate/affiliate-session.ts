...
export class AffiliateSession {
  ...
  get extraSystemPrompt(): string {
    return [
      ...
      "- Each REQUEST_ACTION action must populate exactly one typed payload matching its type: SEND_MESSAGE -> messageText, REVIEW_SAMPLE_APPLICATION -> sampleReviewIntent, CREATE_TARGET_COLLABORATION -> targetCollaborationIntent.",
